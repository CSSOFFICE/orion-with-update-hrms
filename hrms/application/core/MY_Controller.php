...
class MY_Controller extends CI_Controller
{
	public function __construct()
	{
		...
		// API endpoint URL
		// $url = 'https:///check_license';

		// // Data to send to the API (if needed)
		// $data = array(
		// 	'domain_name' => 'http://mahansg.com/hrms',
		// );
		...
		// // Set the request type to POST (if sending data)
		// curl_setopt($curl, CURLOPT_POST, true);

		// // Set the data to send (if needed)
		...
		// // Handle the response (e.g., display or process it)
		// echo $response;
		// if($response == 'false'){
		// 	redirect('https://braincavesoft.com/contact-us');
		// 	exit;
		// }
