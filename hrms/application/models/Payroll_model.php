...
class payroll_model extends CI_Model
{
	...
	public function read_make_payment_allowances($id)
	{

		$sql = 'SELECT * FROM xin_salary_payslip_allowances WHERE payslip_id  in ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
	...
	public function read_make_payment_deduction($id)
	{

		$sql = 'SELECT * FROM xin_salary_deduction WHERE payslip_id  in ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
	...
	public function read_make_payment_loan($id)
	{

		$sql = 'SELECT * FROM xin_salary_payslip_loan WHERE payslip_id  in ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
	...
	public function read_make_payment_statutory_deductions($id)
	{

		$sql = 'SELECT * FROM xin_salary_payslip_statutory_deductions WHERE payslip_id  in ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
	...
	public function read_make_payment_overtime($id)
	{

		$sql = 'SELECT * FROM xin_salary_payslip_overtime WHERE payslip_id  in ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
	...
	public function read_make_payment_commissions($id)
	{

		$sql = 'SELECT * FROM xin_salary_payslip_commissions WHERE payslip_id  in ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
	...
	public function read_make_payment_other_payments($id)
	{

		$sql = 'SELECT * FROM xin_salary_payslip_other_payments WHERE payslip_id  in ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
	...
	public function read_make_payment_claims($id)
	{

		$sql = 'SELECT * FROM xin_salary_payslip_claims WHERE payslip_id  in ?';
		$binds = array($id);
		$query = $this->db->query($sql, $binds);
	...
	public function read_salary_payslip_info_employee_id($id,$salary_month)
	{

		$sql = 'SELECT * FROM xin_salary_payslips WHERE employee_id = ? AND salary_month = ?';
		$binds = array($id,$salary_month);
		$query = $this->db->query($sql, $binds);
