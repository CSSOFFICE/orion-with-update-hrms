		...
		<div class="box">
			...
			<div class="box-body">
				<div id="accordion">
					...
					?>
						<div class="card hrsale-payslip mb-2">
							<div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#set_deduction" aria-expanded="false">
									<strong>Employee Deduction</strong>
								</a> </div>
							<div id="set_deduction" class="collapse" data-parent="#accordion" style="">
								<div class="box-body">
									<div class="table-responsive" data-pattern="priority-columns">
										<table class="datatables-demo table table-striped table-bordered dataTable no-footer">
											<tbody>
												...
												?>
													<tr>
														<td><strong><?php echo $deduction->name; ?>
																:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($deduction->amount, $user_id); ?></span>
														</td>
													</tr>
												<?php } ?>
												<tr>
													<td><strong><?php echo $this->lang->line('xin_acc_total'); ?>:</strong>
														<span class="pull-right"><?php echo $this->Xin_model->currency_sign($deductions_amount, $user_id); ?></span>
													</td>
												</tr>
											</tbody>
										</table>
					...
					?>
						<div class="card hrsale-payslip mb-2">
							<div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#set_claims" aria-expanded="false">
									<strong>Claims</strong>
								</a> </div>
							<div id="set_claims" class="collapse" data-parent="#accordion" style="">
								<div class="box-body">
									<div class="table-responsive" data-pattern="priority-columns">
										<table class="datatables-demo table table-striped table-bordered dataTable no-footer">
											<tbody>
												...
												?>
													<tr>
														<td><strong><?php echo $claim->claim_type; ?>
																:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($claim->amount, $user_id); ?></span>
														</td>
													</tr>
												<?php } ?>
												<tr>
													<td><strong><?php echo $this->lang->line('xin_acc_total'); ?>:</strong>
														<span class="pull-right"><?php echo $this->Xin_model->currency_sign($claim_amount, $user_id); ?></span>
													</td>
												</tr>
											</tbody>
										</table>
									...
									<div class="table-responsive" data-pattern="priority-columns">
										<table class="datatables-demo table table-striped table-bordered dataTable no-footer">
											<tbody>
												...
												?>
													<tr>
														<td><strong><?php echo $allowance->allowance_title; ?>
																:</strong> <span class="pull-right"><?php echo $this->Xin_model->currency_sign($allowance->allowance_amount, $user_id); ?></span>
														</td>
													</tr>
												<?php } ?>
												<tr>
													<td><strong><?php echo $this->lang->line('xin_acc_total'); ?>:</strong>
														<span class="pull-right"><?php echo $this->Xin_model->currency_sign($total_allowance, $user_id); ?></span>
													</td>
												</tr>
											</tbody>
										</table>
						...
						<div class="table-responsive" data-pattern="priority-columns">
							<table class="datatables-demo table table-striped table-bordered dataTable no-footer">
								<tbody>
									...
									<?php } ?>
									<?php if ($total_allowance != 0 || $total_allowance != '') : ?>
										<tr>
											<td><strong><?php echo $this->lang->line('xin_payroll_total_allowance'); ?>:</strong>
												<span class="pull-right"><?php echo $this->Xin_model->currency_sign($total_allowance); ?></span>
											</td>
										</tr>
									<?php endif; ?>
									...
									<?php if ($claim_amount != 0 || $claim_amount != '') : ?>
										<tr>
									...
									<?php if ($net_salary != 0 || $net_salary != '') : ?>
										...
										$total_earning =  (float)$bs + (float)$total_allowance + (float) $total_overtime_amount + (float) $commissions_amount + $total_other_payments + $claim_amount;
