    ...
    <div id="accordion">
        ...
        <div id="add_form1" class="add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
            <div class="box-body">
                ...
                <?php echo form_open_multipart('admin/quotation/update_quotation', $attributes, $hidden);?>
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="project_id" class="form-control" placeholder="Project Name" value="<?php echo $result[0]->project_name; ?>" readonly>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12" id="supplier_address">
                                        ...
                                        <textarea class="form_control col-md-12" name="supplier_name"
                                            id="supplier_name" rows="8" readonly><?php echo $result[0]->f_name."\n". $result[0]->address." ".$result[0]->client_phone;?></textarea>
                                    </div>
                                   
                                    <div class="col-md-6">
                                        <label for="pic_name">PIC Name</label>
                                        <input type="text" name="pic_name" id="pic_name" class="form-control"
                                            placeholder="Attn" value="<?php echo $result[0]->pic_name; ?>" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="pic_email">PIC Email</label>
                                        <input type="email" name="pic_email" id="pic_email" class="form-control"
                                            placeholder="Email" value="<?php echo $result[0]->pic_email; ?>" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="pic_phone">PIC Phone</label>
                                        <input type="email" name="pic_phone" id="pic_phone" class="form-control"
                                            placeholder="Email" value="<?php echo $result[0]->pic_phone; ?>" readonly>
                                    </div>
                                    <!-- <div class="col-md-6">
                                        <label for="quotation_amount">Quotation Amount <i class="hrsale-asterisk">*</i></label>
                                        <input type="text" name="quotation_amount" id="quotation_amount" class="form-control"
                                            placeholder="Quotation Amount" value="<?php //echo $result[0]->quotation_amount; ?>" readonly>
                                    </div> -->
                                    <!-- <div class="col-md-6">
                                        <label for="acceptance_letter_no">Letter of Acceptance No.</label>
                                        <input type="text" name="acceptance_letter_no" id="acceptance_letter_no" class="form-control"
                                            placeholder="Letter of Acceptance No." value="<?php //echo $result[0]->letter_acceptance_no; ?>" readonly>
                                    </div> -->
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <textarea class="form-control"
                                    ...
                                    name="terms_condition" ><?php echo $result[0]->term_condition_description; ?></textarea>
                            </div>
                            <!-- <div class="form-group">
                ...
                <div class="form-actions box-footer">
                        <a href="<?php echo base_url().'admin/finance/quotation_list'; ?>"><button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo $this->lang->line('xin_close');?></button></a>
