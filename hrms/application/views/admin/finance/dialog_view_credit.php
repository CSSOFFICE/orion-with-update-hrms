...
if(isset($_GET['jd']) && isset($_GET['credit_id']) && $_GET['data']=='view_credit'){
?>
...
<div class="modal-body">
    ...
    <div class="row">
                ...
                <label for="first_name"><?php echo $this->lang->line('xin_project').':';?></label>
                    ...
                    <?php foreach($get_all_project as $projects) {
                     if($projects->project_id==$project_id) {
                        echo "<label>".$projects->project_title."</label>"; ?>
                    <?php } 
                    }
                    ?>
                </select>
        ...
        <div class="row">
            ...
            <div class="row" >
                <div class="col-md-12" id="attn_name">
                    ...
                    <input type="text" class="form-control" placeholder="<?php echo $this->lang->line('xin_attn_name');?>" name="attn_name" id="attn_name"  readonly value="<?php echo $attn_name;?>"readonly>
        ...
        <div class="form-group  col-md-12">
                               ...
                               <input type="text" id="u_invoice_date" name="u_invoice_date" class="form-control date" placeholder="Invoice Date" value="<?php echo $invoice_date;?>" readonly>
                            </div>
                            <div  class="form-group col-md-12">
                                        ...
                                        <select class="form-control"
                                            ...
                                            name="payment_term" id="u_terms" readonly>
                            ...
                            <div class="form-group  col-md-12">
                               ...
                               <input type="text" name="u_due_date" id="u_due_date" class="form-control date" placeholder="Invoice Due Date" value="<?php echo $invoice_due_date;?>" readonly>
                            </div>
                            <!-- <div class="form-group col-md-12">
        ...
        <div class="table-responsive my-3 purchaseTable">
                ...
                <tbody class="AddItem1" id="u_vendor_items_table1">
                    ...
                    <td style="min-width:130px">
                        ...
                        <td style="min-width:500px">
                            <textarea name="u_description[]" id="u_description<?php echo $i; ?>" placeholder="Description" style="width:500px" readonly><?php echo $items->job_description; ?></textarea>
                        </td>
                        <td style="min-width:200px">
                            <input type="number" min="0" id="u_cost<?php echo $i; ?>"  class="form-control calculate" name="u_cost[]" id="u_cost_<?php echo $i; ?>" value="<?php echo $items->cost; ?>" placeholder="Cost" onkeyup="u_calculation(<?php echo $i; ?>)" readonly>
                        </td>
                        <td style="min-width:200px">
                             <select class="packing_dropdown form-control select22" name="u_type_id[]" id="u_type_id_<?php echo $i; ?>" onchange="get_type('<?php echo $i; ?>');" readonly>
                        ...
                        <td style="min-width:200px">
                            <input type="text" name="u_amount[]" id="u_amount<?php echo $i; ?>"  placeholder="Total Amount" value="<?php echo $items->total; ?>" class="calculate form-control " onkeyup="u_calculation(<?php echo $i; ?>)" readonly>
                        </td>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row" style="margin-bottom: 0;">
                    <div class="col-12">
                            <input type="checkbox" class="listcheckbox listcheckbox-files filled-in chk-col-light-blue" id="is_gst2" name="is_gst2" value="1" <?php echo(($is_gst_inclusive == "1")?'checked':'');?>><label for="is_gst2">GST Inclusive</label>
                    </div>
                        <div class="col-12" id="gst_div2">
                        
                            <label for="total_gst1" class="form-label">GST</label>
                            <select class="form-control select22" id="u_total_gst1" name="u_gst" onchange="totalGSTAmount()" readonly>
