...
?>
    ...
    <div class="box-body">
        <div class="form-body">
            ...
            <input type="hidden" name="contract_sum1" id="contract_sum1">

            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="project_id1"><?php echo $this->lang->line('xin_project'); ?><i class="hrsale-asterisk">*</i></label>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="project_id"><?php echo "Quotation Number" ?><i class="hrsale-asterisk">*</i></label>
                        <input type="text" name="qt_no1" id="qt_no1" class="form-control" readonly />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="client_id"><?php echo $this->lang->line('xin_customer'); ?><i class="hrsale-asterisk">*</i></label>
                        <select class="form-control" name="client_id1" id="client_id1" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_customer'); ?>">
                            <option value=""><?php echo $this->lang->line('xin_select_one'); ?></option>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" placeholder="Billing Address" id="u_bill_address" name="u_bill_address" data-plugin="select_hrm">
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" placeholder="Delivery Address" id="u_delivery_address" name="u_delivery_address" data-plugin="select_hrm">
                        </select>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function loadInvoiceData(invoice_id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#contract_sum1").val(response.records[0].contract_sum);
                        ...
                        $("#data_table1 tbody").append(`
                            ...
                            <tr>
                                ...
                                ${(record.product_id !== null && !isNaN(record.product_id)) ? `
                                    <select name="u_item1[${index}]" class="form-control item_name1" id="u_item1_${index + 1}" onchange="updateUnit(this, ${index + 1})" data-plugin="select_hrm">
                                ...
                                ` : `
                                    ...
                                    <textarea rows="5" name="item_description1[${index}]" id="item_description1_${index + 1}" class="form-control" >${record.job_description}</textarea>
        ...
        $("#add_product1").click(function() {
            ...
            $("#data_table1 tbody").append(`
                <tr>
                    <td>${rowCount}</td>
                    <td>
                        <select name="u_item1[${rowCount3}]" id="u_item1_${rowCount}" class="form-control item_name1" required onchange="updateUnit(this, ${rowCount})" data-plugin="select_hrm">
                            <option value="">Select Item</option>
            ...
            $("#data_table1 tbody").append(`
                <tr>
                    ...
                    <td>
                        ...
                        <textarea rows="5" id="item_description1_${rowCount}" name="item_description1[${rowCount2}]" class="form-control"></textarea>                                  
                    </td>
                    <td><input type="text" name="quantity1[]" id="quantity1_${rowCount}" class="form-control" oninput="updateRowTotal1(this)"></td>
        ...
        $(document).ready(function() {
            const preSelectedMilestone = <?php echo $mile_id ?>;
            if (preSelectedMilestone) {
                $("#milestone1").val(preSelectedMilestone).trigger("change");
            }
            const preSelectedTask = <?php echo $task_id ?>;
            if (preSelectedTask) {
                $("#task1").val(preSelectedTask);
            }
            $('#project_id1').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#quotation_no1').val('');
                        $('#estimate_id1').val('');
                        $('#milestone1').empty(); // Clear the milestone dropdown
                        ...
                        if (response.quotation_no && response.quotation_no.length > 0) {
                            $('#qt_no1').val(response.quotation_no[0].quotation_no);
                            $('#quotation_no1').val(response.quotation_no[0].quotation_no);
                            $('#estimate_id1').val(response.quotation_no[0].bill_estimateid);
                        } else {
