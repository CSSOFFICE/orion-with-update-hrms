...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="edit-Individual-modal-data"><?php echo "Edit Company Quotation Data";?></h4>
</div>
<?php $attributes = array('name' => 'edit_com_pro_crm', 'id' => 'edit_com_quote_crm', 'autocomplete' => 'off', 'class'=>'m-b-1');?>
<?php $hidden = array('_method' => 'EDIT', '_token' => $crm_com_qt_id, 'ext_name' => $crm_com_qt_id);?>
<?php echo form_open('admin/crm/com_quote_update/'.$crm_com_qt_id, $attributes, $hidden);?>
<div class="modal-body">
<div class="row">
                    <input type="hidden" name="crm_com_qt_id" value="<?php echo $crm_com_qt_id; ?>">
                    <input type="hidden" name="com_qt_for" id="userid" value="<?php echo $com_qt_for; ?>">
                            <div class="col-md-12">                                                                                               
                            <div class="row">                                    
                                    <div class="col-md-3">
                                        <div class="form-group">
                                        <label>Project Title<i class="hrsale-asterisk">*</i></label>
                                            <select name="com_proj_id" id="com_proj_id" class="form-control">
                                                <option value="" disabled>select option</option>
                                                <?php foreach($projects as $project){ ?>
                                                    <option value="<?php echo $project->crm_com_proj_id; ?>" 
                                                    <?php echo ($project->crm_com_proj_id == $com_proj_id) 
                                                      ? 'selected' : ''; ?>
                                                    ><?php echo $project->crm_com_proj_title; ?></option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>ATTN<i class="hrsale-asterisk">*</i></label>
                                            <input type="text" name="com_quote_attn" id="com_quote_attn" class="form-control"
                                            placeholder="Contact Number" value="<?php echo $com_quote_attn;?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Quotation Amount</label>
                                            <input type="text" name="com_quote_amnt" id="com_quote_amnt" class="form-control"
                                            placeholder="Customer Email" value="<?php echo $com_quote_amnt;?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Letter of Acceptance No<i class="hrsale-asterisk">*</i></label>
                                            <input type="text" name="com_quote_letter" id="com_quote_letter" class="form-control"
                                            placeholder="Project Description" value="<?php echo $com_quote_letter;?>">
                                        </div>
                                    </div> 
                                </div>
                                <div class="row pt-4">
...
$("#edit_com_quote_crm").submit(function(e) {
e.preventDefault();
var obj = $(this),
...
$.ajax({
    type: "POST",
    url: base_url + "/com_quote_update",
    data: obj.serialize() + "&is_ajax=1&edit_type=edit_com_quote_crm&form=" + action,
    cache: false,
    success: function(JSON) {
        if (JSON.error != '') {
