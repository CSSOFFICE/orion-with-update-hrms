                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="javascript:void(0)"
                            ...
                            data-toggle="modal" data-target="#commonModal" data-url="<?php echo $base_url.'projects/create'?>"
                            data-loading-target="commonModalBody" data-modal-title="{{ cleanLang(__('lang.add_project')) }}"
                            data-action-url="<?php echo $base_url.'/projects'?>" data-action-method="POST"
                        ...
                        <a href="javascript:void(0)"
                            ...
                            data-url="<?php echo $base_url.'/tasks/create?ref=quickadd'?>" data-loading-target="commonModalBody"
                            data-modal-title="{{ cleanLang(__('lang.add_task')) }}" data-action-url="<?php echo $base_url.'/tasks?ref=quickadd'?>"
                        ...
                        <a href="javascript:void(0)"
                            class="dropdown-item dropdown-item-iconed edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                            data-toggle="modal" data-target="#commonModal"
                            data-url="<?php echo $base_url.'estimates/create?ref=quickadd'?>" data-loading-target="commonModalBody"
                            data-modal-title="{{ cleanLang(__('lang.add_estimate')) }}"
                            data-action-url="<?php echo $base_url.'estimates?ref=quickadd'?>" data-action-method="POST"
                            data-action-ajax-loading-target="commonModalBody" data-save-button-class=""
                            data-project-progress="0">
                            <i class="sl-icon-calculator"></i> Quotation </a>
                        <!-- @endif -->
                        ...
                        <a href="javascript:void(0)"
                            class="dropdown-item dropdown-item-iconed edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                            data-toggle="modal" data-target="#commonModal"
                            data-url="<?php echo $base_url.'expenses/create?ref=quickadd'?>" data-loading-target="commonModalBody"
                            data-modal-title="{{ cleanLang(__('lang.add_expense')) }}"
                            data-action-url="<?php echo $base_url.'expenses?ref=quickadd'?>" data-action-method="POST"
                            data-action-ajax-loading-target="commonModalBody" data-save-button-class=""
                            data-project-progress="0">
