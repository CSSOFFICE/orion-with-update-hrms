...
<script src="public/vendor/js/vendor.footer.js?v=1"></script>

<!--nextloop.core.js-->
<script src="public/js/core/ajax.js?v=1"></script>

<!--MAIN JS - AT END-->
<script src="public/js/core/boot.js?v=1"></script>

<!--EVENTS-->
<script src="public/js/core/events.js?v=1"></script>

<!--CORE-->
<script src="public/js/core/app.js?v=1"></script>

<!--BILLING-->
<script src="public/js/core/billing.js?v=1"></script>

<!--project page charts-->
<!-- @if(@config('visibility.projects_d3_vendor'))
<script src="public/vendor/js/d3/d3.min.js?v=1"></script>
<script src="public/vendor/js/c3-master/c3.min.js?v=1"></script>
@endif -->
...
<?php if ($this->router->fetch_class() == 'calendar' || $this->router->fetch_class() == 'dashboard' || $this->router->fetch_method() == 'timecalendar' || $this->router->fetch_method() == 'projects_calendar' || $this->router->fetch_method() == 'tasks_calendar' || $this->router->fetch_method() == 'quote_calendar' || $this->router->fetch_method() == 'invoice_calendar' || $this->router->fetch_method() == 'projects_dashboard' || $this->router->fetch_method() == 'accounting_dashboard') { ?>
    ...
    <script src="<?php echo base_url(); ?>skin/hrsale_assets/theme_assets/bower_components/fullcalendar/plugins/gcal.js">
    </script>
<?php } ?>
