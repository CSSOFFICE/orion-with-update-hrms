...
<div class="d-flex flex-wrap <?php echo $get_animate;?>" style="margin-bottom:10px; gap:0.5rem;">
    <div>
        ...
        <button type="submit"
            class="btn btn-primary save"><?php echo $this->lang->line('xin_delete_old_backup');?></button>
        <?php echo form_close(); ?>
    </div>
...
<div class="box  <?php echo $get_animate;?>">
    <div class="box-header with-border">
        <h3 class="box-title"><?php echo $this->lang->line('xin_add_new');?>
            <?php echo $this->lang->line('xin_backup_log');?></h3>
    </div>
    <div class="box-body">
