...
if(isset($_GET['jd']) && isset($_GET['w_id']) && $_GET['data']=='warehouse'){
?>
...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="edit-modal-data"><?php echo "Edit Warehouse";?></h4>
</div>
<?php $attributes = array('name' => 'edit_warehouse', 'id' => 'edit_warehouse', 'autocomplete' => 'off', 'class'=>'m-b-1');?>
<?php $hidden = array('_method' => 'EDIT', '_token' => $w_id, 'ext_name' => $w_id);?>
<?php echo form_open('admin/warehouse/update/'.$w_id, $attributes, $hidden);?>
                            ...
                            <div class="col-md-12">                                                                                               
                                ...
                                <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="w_name"><?php echo "Warehouse Name";?>
                                                <i class="hrsale-asterisk">*</i></label>
                                            </label>
                                            <input class="form-control"
                                                placeholder="<?php echo "Warehouse Name";?>" 
                                                name="w_name" type="text" value="<?php echo $w_name;?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="w_address"><?php echo "Warehouse Address";?>
                                                <i class="hrsale-asterisk">*</i></label>
                                            </label>
                                            <input class="form-control"
                                                placeholder="<?php echo "Warehouse Address";?>" 
                                                name="w_address" type="text" value="<?php echo $w_address;?>">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="w_unit_no"><?php echo "Warehouse Unit Number";?>
                                                <i class="hrsale-asterisk">*</i></label>
                                            </label>
                                            <input class="form-control"
                                                placeholder="<?php echo "Warehouse Unit Number";?>" 
                                                name="w_unit_no" type="text" value="<?php echo $w_unit_no;?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="w_postal_code"><?php echo "Warehouse Postal Code";?>
                                                <i class="hrsale-asterisk">*</i></label>
                                            </label>
                                            <input class="form-control"
                                                placeholder="<?php echo "Warehouse Postal Code";?>" 
                                                name="w_postal_code" type="text" value="<?php echo $w_postal_code;?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="org_id" type="text">
                                                ...
                                                <?php foreach($get_org as $org){?>
                                                    <option value="<?php echo $org['company_id']?>" <?php if($org['company_id']==$org_id){echo "selected";}?>><?php echo $org['name']?></option>
                                                <?php }?>
                                            </select>
                                        </div>
                                        </div>
    ...
    success: function(JSON) {
        if (JSON.error != '') {
            ...
            var xin_table = $('#xin_table').dataTable({
                        "bDestroy": true,
                        "ajax": {
                            url: "<?php echo site_url("admin/warehouse/warehouselist") ?>",
                            type: 'GET'
                        },
                        dom: 'lBfrtip',
