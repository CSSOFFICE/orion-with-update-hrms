                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
															<div class="form-group">
                                                                ...
                                                                <?php if($signature):?>
																    <img src="<?php echo base_url('uploads/document/signature/' . $signature) ?>" class="img-fluid" width="80px">
                                                                <?php endif;?>
																<input type="file" class="form-control" name="sig1" id="sig1" value="<?php echo $signature ?>">
															</div>
														</div>
