...
$(document).ready(function () {
    var timeoutID = null;
    var delayTime = 1000; // 1 second delay

    function nxDynamicSearch_rk(self, e) {
    ...
    // Input or change event triggers the delayed search
    $(document).on('change', '.client_status', function (e) {
        // console.log($(this).data('id'));
        $("#exampleRadio2").prop('checked', false)
        var nxSearchRecord = $(this);
        clearTimeout(timeoutID); // Clear previous timeout
        timeoutID = setTimeout(() => nxDynamicSearch_rk(nxSearchRecord, e), delayTime); // Set a new timeout
    });
});
$(document).ready(function () {
    var timeoutID = null;
    ...
    // Input or change event triggers the delayed search
    $(document).on('change', '.client_status_b', function (e) {


        $('#exampleRadio1').prop('checked', false);
...
$(document).on('click', '.confirm-action-danger, .confirm-action-info, .confirm-action-success', function () {
    ...
    // let htm = '<label>Delete WereHouse <input type="checkbox" name="confirm_option" class="project_delete_c" value="option1" style="position:static;opacity:1;"></label>';
    //manually trigger confirm
    $.confirm({
...
$(document).ready(function () {
    ...
    $(document).on('change input', '.search-records', function (e) {
        var nxSearchRecord = $(this);
