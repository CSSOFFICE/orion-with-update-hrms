...
NXINVOICE.DOM.itemNewLine = function (data = {}) {
    ...
    var item = (data.item != null) ? data.item : '';
    ...
    lineitem.find(".item").attr("name", "item[" + uniqueid + "]");
...
NXINVOICE.DOM.productNewLine = function (data = {}) {

    NXINVOICE.log("[billing] NXINVOICE.DOM.productNewLine() - cloning time line - [payload]");
    NXINVOICE.log(data);
    ...
    //new element (plain)
    var lineitem = $("#billing-line-template-product").find('tr').first().clone();
