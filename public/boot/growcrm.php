...
$paths = [
    ...
    '/orion/updates',
    '/orion/storage',
    '/orion/storage/avatars',
    '/orion/storage/logos',
    '/orion/storage/logos/clients',
    '/orion/storage/logos/app',
    '/orion/storage/files',
    '/orion/storage/temp',
    '/orion/application/storage/app',
    '/orion/application/storage/app/public',
    '/orion/application/storage/cache',
    '/orion/application/storage/cache/data',
    '/orion/application/storage/debugbar',
    '/orion/application/storage/framework',
    '/orion/application/storage/framework/cache',
    '/orion/application/storage/framework/cache/data',
    '/orion/application/storage/framework/sessions',
    '/orion/application/storage/framework/testing',
    '/orion/application/storage/framework/views',
    '/orion/application/storage/logs',
    '/orion/application/bootstrap/cache',
    '/orion/application/storage/app/purifier',
    '/orion/application/storage/app/purifier/HTML',
