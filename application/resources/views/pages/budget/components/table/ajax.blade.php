...
<tr id="client_{{ $client->task_id }}">
    ...
    <td class="clients_col_company" id="clients_col_id_{{ $client->task_id }}">
        <span
            style="width:250px;word-wrap:break-word;white-space:normal;">{{ $client->task_title ?? '---' }}</span>
    </td>
    ...
    <td class="clients_col_company " style="background-color: coral;"
        id="clients_col_id_{{ $client->task_id }}"><input type="number"
            data-t_id="{{ $client->task_id }}" data-c_id="{{ $client->task_cat_id }}"
    ...
    <td class="clients_col_company contract" id="clients_col_id_{{ $client->task_id }}">
        {{ str_limit($client->purchase_order_total_format ?? 00, 35) }}
    </td>


    <td class="clients_col_company subcontractor_amount" id="clients_col_id_{{ $client->task_id }}">
        {{ subcontractor_amount($client->task_cat_id, $client->task_id, $client->task_projectid) }}
    </td>

    <td class="clients_col_company pettycase" id="clients_col_id_{{ $client->task_id }}">
    ...
    <td class="clients_col_company itemized surplus_deficit" style="background-color: greenyellow;"
        ...
        {{ number_format($surplus_deficit, 2) }}
    </td>
    <td class="clients_col_company" id="clients_col_id_{{ $client->task_id }}">
...
<tr>
    ...
    <td>{{ number_format($subcontractor_amount, 2) }}</td>
