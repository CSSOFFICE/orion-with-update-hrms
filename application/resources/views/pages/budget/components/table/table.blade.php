                ...
                <thead>
                    <tr>
                        ...
                        <th class="clients_col_status">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_client_status"
                                href="javascript:void(0)"
                                data-url="{{ urlResource('/clients?action=sort&orderby=client_status&sortorder=asc') }}"> Purchase Order Amount (B)<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                        <th class="clients_col_status">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_client_status"
                                href="javascript:void(0)"
                                data-url="{{ urlResource('/clients?action=sort&orderby=client_status&sortorder=asc') }}">Sub-Contractor Amount (C)<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                        {{-- <th class="clients_col_status">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_client_status"
                                href="javascript:void(0)"
                        ...
                        <th class="clients_col_status">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_client_status"
                                href="javascript:void(0)"
                                data-url="{{ urlResource('/clients?action=sort&orderby=client_status&sortorder=asc') }}">Petty Cash (D)<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>                        
                        <th class="clients_col_status" style="background-color: greenyellow;">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_client_status"
                                href="javascript:void(0)"
                                data-url="{{ urlResource('/clients?action=sort&orderby=client_status&sortorder=asc') }}">Surplus/Deficit A-B-C-D
