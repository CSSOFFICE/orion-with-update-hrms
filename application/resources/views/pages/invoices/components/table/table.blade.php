                ...
                <thead>
                    <tr>
                        ...
                        <th class="invoices_col_id"><a class="js-ajax-ux-request js-list-sorting" id="sort_bill_invoiceid"
                                ...
                                data-url="{{ urlResource('/invoices?action=sort&orderby=bill_invoiceid&sortorder=asc') }}">{{ "Invoice No" }}<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
