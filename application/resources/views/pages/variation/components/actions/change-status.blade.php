<div class="form-group row">
    ...
    <div class="col-sm-12">
        <select class="select2-basic form-control form-control-sm" id="bill_status" name="bill_status">
            ...
            <option value="new" {{ runtimePreselected('new', $estimate->bill_status)}}>Waiting for Customer Approval</option>
            <option value="waiting_for_approval" {{ runtimePreselected('waiting_for_approval', $estimate->bill_status)}}>Waiting for Management Approval</option>
            <option value="accepted" {{ runtimePreselected('accepted', $estimate->bill_status) }}>{{ "Approval" }}</option>
