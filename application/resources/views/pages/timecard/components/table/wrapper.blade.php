<!--bulk actions-->
{{-- @include('pages.timecard.components.actions.checkbox-actions')
<button type="button" class="btn icon-btn btn-xs  btn-warning float-right ml-1"
    onclick="downloadDummyArray()">Sample</button>
<button type="button" class="btn icon-btn btn-xs  btn-warning float-right" data-toggle="modal" data-target="#myModal">
    Bulk Upload
</button> --}}

<!--main table view-->
@include('pages.timecard.components.table.table')
<!--filter-->
@if (auth()->user()->is_team)
    @include('pages.timecard.components.misc.filter-timesheets')
@endif
<!--timesheets-->
