...
<tr id="team_{{ $team->id }}">
    <td class="team_col_first_name">
        ...
        <span class="sl-icon-star text-warning p-l-5" data-toggle="tooltip" title="{{ cleanLang(__('lang.main_administrator')) }}"
            id="team_admin_{{ $team->id }}"></span>
        @endif
    </td>
    ...
    {{-- <td class="team_col_action"> --}}
        ...
        {{-- <span class="list-table-action dropdown font-size-inherit"> --}}
            ...
            <button type="button" title="{{ cleanLang(__('lang.delete')) }}"
                ...
                data-ajax-type="DELETE" data-url="{{ url('/') }}/team/{{ $team->id ?? '' }}">
