<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row d-none">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ cleanLang(__('lang.mobile_no')) }}*</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="mobile_no" name="mobile_no" value="{{ $client->client_phone ?? '' }}" placeholder="">
            </div>
        </div>
        <div class="form-group row d-none">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ cleanLang(__('lang.payment_type')) }}*</label>
            <div class="col-sm-12 col-lg-9">
            <input type="text" class="form-control form-control-sm" id="payment_type" name="payment_type" value="{{ $client->payment_type ?? '' }}" placeholder="">
            </div>
        </div>
        <div class="form-group row d-none">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ cleanLang(__('lang.credit_term')) }}*</label>
            <div class="col-sm-12 col-lg-9">
                <textarea class="form-control form-control-sm" id="credit_term" name="credit_term" placeholder="">{{ $client->credit_term ?? '' }}</textarea>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">Remarks</label>
            <div class="col-sm-12 col-lg-9">
                <textarea class="form-control form-control-sm" id="remarks" name="remarks" placeholder="">{{ $user->remarks ?? '' }}</textarea>
            </div>
        </div>
