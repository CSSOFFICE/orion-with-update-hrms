...
<table style="border: 1px solid black;!important;">
    <thead style="text-align:center;">
        ...
        <tr>
            ...
            <th
                style="text-align:center;background-color:#FEF2CB;border-right:5px solid black;border-left:5px solid black;">
                <strong>$ {{ number_format($quotation_data['SCHEDULE OF WORKS']['total'], 2) }}</strong>
            </th>
        </tr>
        <tr>
            <th style="border-right:5px solid black;border-left:1px solid black;"></th>
    ...
    <tbody>
        @php
            ...
            $rowIndex = 1;
        @endphp
        @foreach ($quotation_data['SCHEDULE OF WORKS']['data'] as $key => $item)
            @if ($item->type == 'head')
                <tr>
                    <td style="border: 1px solid black;vertical-align:right;background-color:#E2EFD9;">{{ $letterCounter }}</td>
                    <td style="border: 1px solid black;width: 350px; word-wrap: break-word; white-space: normal;background-color:#E2EFD9;">{{ $item->description }}</td>
    ...
    <tfoot>
        <tr>
            ...
            <td style="text-align:center;border:1px solid black;">
                $ {{ number_format($quotation_data['SCHEDULE OF WORKS']['total'], 2) }}</td>
