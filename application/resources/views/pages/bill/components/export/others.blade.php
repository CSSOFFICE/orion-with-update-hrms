...
<table style="border: 1px solid black;!important;">
    <thead style="text-align:center;">
        ...
        <tr>
            ...
            <th
                ...
                <b>BILL NO. 7 - Provide the following Prime Cost &amp; Provisional Sums for works to be executed by Nominated Suppliers &amp; Sub-Contractors or expended by Architect as directed. The sums shall be adjusted in due course.</b>
            </th>
            <th
            ...
            <th
                style="text-align:center;background-color:#FEF2CB;border-right:5px solid black;border-left:5px solid black;">
                <strong>$ {{ number_format($quotation_data['OTHERS']['total'], 2) }}</strong>
            </th>
        </tr>
        <tr>
            <th style="border-right:5px solid black;border-left:1px solid black;"></th>
    ...
    <tbody>
        @php
            ...
            $rowIndex = 1;
        @endphp
        @foreach ($quotation_data['OTHERS']['data'] as $key => $item)
            @if ($item->type == 'head')
                <tr>
    ...
    <tfoot>
        <tr>
            ...
            <td style="text-align:center;border:1px solid black;">
                $ {{ number_format($quotation_data['OTHERS']['total'], 2) }}</td>
