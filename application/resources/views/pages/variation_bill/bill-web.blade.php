...
<script type="text/javascript">
    ...
    <div class="card card-body invoice-wrapper box-shadow" id="invoice-wrapper">
        ...
        @if ($bill->bill_type == 'invoice')
            @include('pages.variation_bill.components.elements.invoice.header-web')
        @endif
        @if ($bill->bill_type == 'estimate')
            @include('pages.variation_bill.components.elements.estimate.header-web')
        @endif
        ...
        <div class="row">
            ...
            @if ($bill->bill_type == 'invoice')
                <div class="col-12" id="invoice-dates-wrapper">
                    @include('pages.variation_bill.components.elements.invoice.dates')
                    @include('pages.variation_bill.components.elements.invoice.payments')
                </div>
            @endif
            @if ($bill->bill_type == 'estimate')
                <div class="col-12 " id="invoice-dates-wrapper">
                    @include('pages.variation_bill.components.elements.estimate.dates')
                </div>
            @endif


            <!--INVOICE TABLE-->
            @include('pages.variation_bill.components.elements.main-table')


            <!--[EDITING] INVOICE LINE ITEMS BUTTONS -->
            @if (config('visibility.bill_mode') == 'editing')
                <div class="col-12">
                    @include('pages.variation_bill.components.misc.add-line-buttons')
                </div>
            @endif


            <!-- TOTAL & SUMMARY -->
            @include('pages.variation_bill.components.elements.totals-table')
    ...
    <!--INVOICE LOGIC-->
    @if (config('visibility.bill_mode') == 'editing')
        @include('pages.variation_bill.components.elements.logic')
    @endif
...
@if (config('visibility.bill_mode') == 'editing')
    ...
    <!--MODALS-->
    @include('pages.variation_bill.components.modals.items')
    @include('pages.variation_bill.components.modals.expenses')
    @include('pages.variation_bill.components.timebilling.modal')
