<table class="table table-bordered border-secondary">
    ...
    <tbody id="pcps-table-body">
        <tr style="background-color:#FEF2CB">
            ...
            <th class="text-start" style="text-align:left!important;"><b>BILL NO. 7 - Provide the following Prime Cost
    ...
    <tfoot>
        {{-- <tr id="subtotal-row" style="border-top: 2px solid black;">
            <td></td>
            <td style="text-align:left;" colspan="13"><b>TOTAL PROVISIONAL SUMS CARRIED TO GENERAL SUMMARY OF
                    TENDER</b>
            </td>

            <td id="total-subtotal">{{$pcps['total']}}</td>
            <td id="amount-subtotal">${{ number_format($pcps['total'], 2) }}</td>
        </tr>
        <tr>
            <td></td>
            <td colspan="13"><b><u>PROFIT & ATTENDANCE ALLOWANCE</u></b></td>
            <td id="amount-subtotal"></td>
        </tr>
        <tr>
            <td></td>
            <td colspan="13">Allow for Main Contractor’s profit on P.C. Items</td>
            <td id="amount-subtotal">${{ number_format(0.05 * $pcps['total'], 2) }}</td>
        </tr>
        <tr>
            <td></td>
            <td colspan="13">Allow for Main Contractor’s attendance on P.C. Items.</td>
            <td id="amount-subtotal">${{ number_format(0.05 * $pcps['total'], 2) }}</td>
        </tr> --}}
        ...
        <tr style="border-bottom: 2px solid black;border-top: 1px solid black;">
            ...
            <td></td>
            {{-- <td></td> --}}
            <td>${{ number_format($pcps['total'], 2) }}</td>
        </tr>
    </tfoot>
</table>
