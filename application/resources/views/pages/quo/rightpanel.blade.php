    ...
    <div class="x-section">
        ...
        <!--status-->
        <div class="x-element" id="card-task-status"><i class="mdi mdi-flag"></i> <span>{{ cleanLang(__('lang.status')) }}: </span>
            @if($task->permission_edit_task)
        ...
        <!--priority-->
        <div class="x-element" id="card-task-priority"><i class="mdi mdi-verified"></i> <span>{{ cleanLang(__('lang.priority')) }}:
            </span>
            @if($task->permission_edit_task)
    ...
    <div class="x-section">
        ...
        <div class="x-element x-action confirm-action-danger" data-confirm-title="{{ cleanLang(__('lang.stop_all_timers')) }}"
            ...
            <span class="x-highlight" id="task-start-date">{{ cleanLang(__('lang.stop_all_timers')) }}</span></span></div>
        @php $count_action ++ ; @endphp
        @endif

        <!--delete-->
        @if($task->permission_delete_task)
        <div class="x-element x-action confirm-action-danger" data-confirm-title="{{ cleanLang(__('lang.delete_item')) }}"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong><span id="task_timer_all_card_{{ $task->task_id }}">{!!
                                    clean(runtimeSecondsHumanReadable($task->sum_all_time, false)) !!}</span></strong>
                        </td>
                    </tr>
                    <tr>
