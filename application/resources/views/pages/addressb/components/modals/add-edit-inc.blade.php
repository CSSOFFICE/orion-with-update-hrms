<div class="row">
    <div class="col-lg-12">
        ...
        <input type="hidden" name="clientid" id="clientid" value="{{ $address->client_id ?? '' }}">
    ...
    <div id="add_client_billing_address_section" class="hiddenn">
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ 'Person Incharge' }}</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="p_i" name="p_i"
                    value="{{ $client->p_i ?? '' }}">
            </div>
        </div>
        <div class="form-group row d-none">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ 'Email' }}</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="p_email" name="p_email"
                    value="{{ $client->p_email ?? '' }}">
            </div>
        </div>
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ 'Contact number' }}</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="p_contact" name="p_contact"
                    value="{{ $client->p_contact ?? '' }}">
            </div>
        </div>
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ "Postal Code" }}</label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ 'Unit Number' }}</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="p_contact" name="p_unit"
                    value="{{ $client->p_unit ?? '' }}">
            </div>
        </div>
    ...
    <div id="add_client_billing_address_section" class="hiddenn">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="client_billing_zip"
                    name="client_billing_zip" value="{{ $address->zipcode ?? '' }}">
            </div>
        </div>
        <div class="form-group row">
            <label
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="p_contact" name="p_unit"
                    value="{{ $address->p_unit ?? '' }}">
            </div>
        </div>

        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required">{{ cleanLang(__('lang.street')) }}</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="client_billing_street"
                    name="client_billing_street" value="{{ $address->street ?? '' }}">
            </div>
        </div>
        <div class="form-group row hidden">
            <label
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="client_billing_city"
                    name="client_billing_city" value="{{ $address->city ?? '' }}">
            </div>
        </div>
        <div class="form-group row hidden">
            <label
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="client_billing_state"
                    name="client_billing_state" value="{{ $address->state ?? '' }}">
            </div>
        </div>
        ...
        <div class="form-group row">
            <label for="example-month-input"
                class="col-sm-12 col-lg-3 col-form-label text-left">{{ cleanLang(__('lang.country')) }}</label>
            <div class="col-sm-12 col-lg-9">
                @php $selected_country = $address->country ?? ''; @endphp
                <select class="select2-basic form-control form-control-sm" id="client_billing_country"
                    name="client_billing_country" data-minimum-results-for-search="1">
                    <option></option>
                    @include('misc.country-list')
