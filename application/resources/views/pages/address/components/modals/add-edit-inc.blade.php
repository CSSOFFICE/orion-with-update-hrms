<div class="row">
    ...
    <div id="add_client_billing_address_section" class="hiddenn">
        ...
        <div class="form-group row ">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="p_email"
                    name="p_email" value="{{ $client->p_email ?? '' }}">
            </div>
        </div>
        <div class="form-group row">
            <label
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="p_contact"
                    name="p_contact" value="{{ $client->p_contact ?? '' }}">
            </div>
        </div>
        <div class="form-group row">
            <label
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="p_contact"
                    name="p_unit" value="{{ $client->p_unit ?? '' }}">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                ...
                <select class="select2-basic select2-selection form-control form-control-sm" id="client_billing_country" data-plugin="select_hrm"
                    name="client_billing_country" data-placeholder="{{ cleanLang(__('lang.country')) }}" data-minimum-results-for-search="1">
                    <option></option>
    ...
    <div id="add_client_billing_address_section" class="hiddenn">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="p_email"
                    name="p_email" value="{{ $address->p_email ?? '' }}">
            </div>
        </div>
        <div class="form-group row">
            <label
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="p_contact"
                    name="p_contact" value="{{ $address->p_contact ?? '' }}">
            </div>
        </div>
        <div class="form-group row">
            <label
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="p_contact"
                    name="p_unit" value="{{ $address->p_unit ?? '' }}">
            </div>
        </div>
