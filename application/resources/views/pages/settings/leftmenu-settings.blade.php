            ...
            <ul id="sidebarnav">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"
                                ...
                                data-url={{ url('/categories?filter_category_type=client&source=ext') }}>{{ cleanLang(__('lang.clients')) }}
                            </a></li>
                        ...
                        <li><a class="js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"
                                ...
                                data-url={{ url('/categories?filter_category_type=expense&source=ext') }}>{{ cleanLang(__('lang.expenses')) }}
                            </a></li>

                        <!--invoice-->
                        <li><a class="js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"
                                id="settings-menu-categories-invoice" href="app/settings/invoices"
                                data-url={{ url('/categories?filter_category_type=invoice&source=ext') }}>{{ cleanLang(__('lang.invoices')) }}
                            </a></li>
                        ...
                        <li><a class="js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url hidden"
                                ...
                                data-url={{ url('/categories?filter_category_type=item&source=ext') }}>{{ cleanLang(__('lang.products')) }}
                            </a></li>

                        <!--estimate-->
                        <li><a class="js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"
                                id="settings-menu-categories-estimate" href="javascript:void(0);"
                                data-url={{ url('/categories?filter_category_type=estimate&source=ext') }}>{{ cleanLang(__('lang.estimates')) }}
                            </a></li>
                    </ul>
                </li>
                <!--projects-->
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li class="hidden">
                            <a href="javascript:void(0);" data-url={{ url('/settings/units') }} id="settings-menu-billing-unit"
