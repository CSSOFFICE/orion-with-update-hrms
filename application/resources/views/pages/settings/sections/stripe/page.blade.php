...
<form class="form" id="settingsFormStripe">
    ...
    <div class="form-group row">
        <label class="col-12 control-label col-form-label required">{{ cleanLang(__('lang.webhooks_url')) }}*
            <span class="align-middle text-themecontrast font-16" data-toggle="tooltip" title="{{ cleanLang(__('lang.stripe_api_instructions')) }}"
            data-placement="top"><i class="ti-info-alt"></i></span>
        </label>
        <div class="col-12">
    ...
    <div>
        <div class="p-b-10"><strong><small>* {{ cleanLang(__('lang.required')) }} </small></strong></div>
    ...
    <!-- <div class="alert alert-danger m-t-20">{{ cleanLang(__('lang.read_documentation_for_instructions')) }}</div> -->
