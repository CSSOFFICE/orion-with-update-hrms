                ...
                <ul class="nav nav-tabs profile-tab" role="tablist">
                    ...
                    <!--projects-->
                    <li class="nav-item">
                        <a class="nav-link  tabs-menu-item js-dynamic-url js-ajax-ux-request {{ $page['tabmenu_address'] ?? '' }}"
                            data-toggle="tab" data-loading-class="loading-tabs" data-loading-target="embed-content-container" id="tabs-menu-address"
                            data-dynamic-url="{{ url('/clients') }}/{{ $client->client_id }}/address"
                            data-url="{{ url('/address') }}?addressresource_type=client&addressresource_id={{ $client->client_id }}&source=ext&page=1"
                            href="#clients_ajaxtab" role="tab">Billing Address</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  tabs-menu-item js-dynamic-url js-ajax-ux-request {{ $page['tabmenu_addressb'] ?? '' }}"
                            data-toggle="tab" data-loading-class="loading-tabs" data-loading-target="embed-content-container" id="tabs-menu-addressb"
                            data-dynamic-url="{{ url('/clients') }}/{{ $client->client_id }}/addressb"
                            data-url="{{ url('/addressb') }}?addressbresource_type=client&addressbresource_id={{ $client->client_id }}&source=ext&page=1"
