<div class="card count-{{ @count($milestones_list) }}" id="milestones-table-wrapper">
    <div class="card-body">
        <div class="table-responsive">
            ...
            <table id="milestones-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="milestones_col_action w-5 d-none"><a href="javascript:void(0)">{{ cleanLang(__('lang.action')) }}</a></th>
                        @endif
                    </tr>
                </thead>
            ...
            @endif @if (@count($milestones_list) == 0)
            <!--nothing found-->
