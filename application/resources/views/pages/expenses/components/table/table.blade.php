<div class="card count-{{ @count($expenses_data) }}" id="expenses-table-wrapper">
    <div class="card-body">
        <div class="table-responsive list-table-wrapper">
                    ...
                    <tr>
                        ...
                        <th class="expenses_col_date">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_expense_date"
                                ...
                                data-url="{{ urlResource('/expenses?action=sort&orderby=expense_date&sortorder=asc') }}">S/N
                        ...
                        <th class="expenses_col_description">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_expense_description"
                                href="javascript:void(0)"
                                data-url="{{ urlResource('/expenses?action=sort&orderby=expense_description&sortorder=asc') }}">Purchase Invoice No
                        ...
                        <th class="expenses_col_project"><a class="js-ajax-ux-request js-list-sorting"
                                ...
                                data-url="{{ urlResource('/expenses?action=sort&orderby=project&sortorder=asc') }}">{{ "Purchase Order No" }}<span
                        ...
                        <th class="expenses_col_client"><a class="js-ajax-ux-request js-list-sorting"
                                ...
                                data-url="{{ urlResource('/expenses?action=sort&orderby=client&sortorder=asc') }}">Supplier<span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                        @endif
                        ...
                        <th class="expenses_col_date"><a class="js-ajax-ux-request js-list-sorting"
                                ...
                                data-url="{{ urlResource('/expenses?action=sort&orderby=expense_date&sortorder=asc') }}">Date
            ...
            @endif @if (@count($expenses_data) == 0)
            <!--nothing found-->
