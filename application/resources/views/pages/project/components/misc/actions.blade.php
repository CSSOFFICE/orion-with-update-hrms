...
<div class="col-md-12  col-lg-6 align-self-center text-right parent-page-actions p-b-9"
    ...
    <div id="list-page-actions">
        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form"
                    ...
                    data-modal-title="{{ cleanLang(__('lang.change_category')) }}" data-url="{{ url('/projects/change-category') }}"
                ...
                <!--stop all timers-->
                <a href="javascript:void(0)" class="dropdown-item confirm-action-danger d-none" data-confirm-title="{{ cleanLang(__('lang.stop_all_timers')) }}"
        ...
        <button type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.delete_project')) }}"
            ...
            data-confirm-title="{{ cleanLang(__('lang.delete_project')) }}" data-confirm-text="{{ cleanLang(__('lang.are_you_sure')) }}"
            data-ajax-type="DELETE" data-url="{{ url('/projects/'.$project->project_id.'?source=page') }}"><i
