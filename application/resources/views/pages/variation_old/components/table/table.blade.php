        ...
        <div class="table-responsive list-table-wrapper">
            ...
            <table id="estimates-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="estimates_col_id"><a class="js-ajax-ux-request js-list-sorting" id="sort_bill_estimateid"
                                ...
                                data-url="{{ urlResource('/estimates?action=sort&orderby=bill_estimateid&sortorder=asc') }}">Variation No<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                        <th class="estimates_col_date"><a class="js-ajax-ux-request js-list-sorting"
                                id="sort_bill_date" href="javascript:void(0)"
                                data-url="{{ urlResource('/estimates?action=sort&orderby=bill_date&sortorder=asc') }}">{{"Variation Date"}}<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                ...
                <tbody id="estimates-td-container">
                    <!--ajax content here-->
                    @include('pages.variation.components.table.ajax')
                    <!--ajax content here-->
                </tbody>
                <tfoot>
                    <tr>
