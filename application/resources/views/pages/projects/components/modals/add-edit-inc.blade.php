<div class="row" id="js-projects-modal-add-edit" data-section="{{ $page['section'] }}">
    <div class="col-lg-12">
        ...
        <div id="multiple_addre">
            ...
            <div class="chiled_multi_field border-4" id="chiled_multi_field_{{$key}}" style="border: 2px solid #d5b9b9; padding: 8px;">
                <div class="form-group row ">
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <input type="text" name="project_site[{{$key}}]"
                            class="form-control form-control-sm project_site" placeholder="project site..." value="{{ $add->project_site ?? '' }}">
                    </div>
                </div>
                <div class="form-group row ">
                    <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">Postal code</label>
                    <div class="col-sm-12 col-lg-9">
                        <input type="number" data-id="0" class="form-control form-control-sm employee_postal" id="employee_postal_0" name="employee_postal[{{$key}}]"
                            placeholder="" value="{{ $add->employee_postal ?? '' }}">
                    </div>
                </div>
                <div class="form-group row ">
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <input type="text" class="form-control form-control-sm" id="project_address_0"
                            name="project_address[{{$key}}]" placeholder="" value="{{ $add->project_address ?? '' }}">
                        <input type="hidden" name="longitude[{{$key}}]" id="longitude_{{$key}}" class="form-control form-control-sm" value="{{ $add->longitude ?? '' }}">
                        <input type="hidden" name="latitude[{{$key}}]" id="latitude_{{$key}}" class="form-control form-control-sm" value="{{ $add->latitude ?? '' }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <select name="assigned[{{$key}}]" id="assigned_{{$key}}" data-id="assigned_{{$key}}"
