                        ...
                        <tr>
                            ...
                            <th class="projects_col_id">
                                <a class="js-ajax-ux-request js-list-sorting" id="sort_project_id"
                                    ...
                                    data-url="{{ urlResource('/projects?action=sort&orderby=project_id&sortorder=asc') }}">{{ 'PR Code' }}<span
                            ...
                            @if ($d->role_name == 'Super Admin' || $d->role_name == 'Manager')
                                <th class="projects_col_status ">
                                    <a class="js-ajax-ux-request js-list-sorting" id="sort_project_status"
                                        href="javascript:void(0)"
                                        data-url="{{ urlResource('/projects?action=sort&orderby=project_status&sortorder=asc') }}">{{ 'Contact Sum' }}<span
                                            class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                                </th>
                            @endif
