...
<div class="row" id="js-trigger-clients-modal-add-edit" data-payload="{{ $page['section'] ?? '' }}">
    <div class="col-lg-12">
        ...
        @if (isset($page['section']) && $page['section'] == 'edit' && $client->cust_type == 1)
            <input type="hidden" name="cust_type" id="cust_type" value="{{ $client->cust_type }}">
            {{-- <div class="form-group row">
                <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">Customer Code</label>
                <div class="col-sm-12 col-lg-9">
                    <input type="number" class="form-control form-control-sm" id="cust_code" name="customer_code"
                        placeholder="" value="{{ $client->cust_code1 ?? ' ' }}">
                </div>
            </div> --}}
            <div class="form-group row ">
                ...
                <div class="col-sm-12 col-lg-9">
                    <input type="text" class="form-control form-control-sm" id="first_name" name="first_name"
                        placeholder="" value="{{ $client->f_name ?? ' ' }}">
                </div>
            </div>
            <div class="form-group row">
                <label
                ...
                <div class="col-sm-12 col-lg-9">
                    <input type="text" class="form-control form-control-sm" id="email" name="cu_email"
                        placeholder="" value="{{ $client->u_email ?? ' ' }}">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-9">
                    <input type="text" class="form-control form-control-sm" id="mobile_no" name="cu_mobile_no"
                        placeholder="" value="{{ $client->client_phone ?? ' ' }}">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-9">
                    ...
                    <select class="form-control" name="cu_currency">
                        ...
                        <option value="{{ $cur->currency_id }}"
                            {{ runtimePreselected($cur->currency_id, $client->currency ?? '') }}> {{ $cur->name }}
                            ({{ $cur->symbol }}) </option>
                        <?php }?>
                    </select>
                </div>
        ...
        @if (isset($page['section']) && $page['section'] == 'edit' && $client->cust_type == 0)
            <input type="hidden" name="cust_type" id="cust_type" value="{{ $client->cust_type }}">
            {{-- <div class="form-group row">
                <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">Customer Code</label>
                <div class="col-sm-12 col-lg-9">
            ...
            <div class="form-group row ">
                ...
                <div class="col-sm-12 col-lg-9">
                    <input type="text" class="form-control form-control-sm" id="client_company_name"
                        name="client_company_name" placeholder="" value="{{ $client->client_company_name ?? ' ' }}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-9">
                    <input type="text" class="form-control form-control-sm" id="com_uen" name="com_uen"
                        placeholder="" value="{{ $client->com_uen ?? '' }}">
                </div>
            </div>
            <div class="form-group row">
                <label
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-sm-12 col-lg-9">
                        ...
                        <select class="form-control" name="c_currency">
                            <option value="">Select</option>
                            <?php foreach($currency as $cur){?>
                            <option value="{{ $cur->currency_id }}"> {{ $cur->name }} ({{ $cur->symbol }})
                            </option>
                            <?php }?>
                        </select>
                    </div>
