...
<tr id="client_{{ $client->client_id }}">
    <td class="clients_col_id" id="clients_col_id_{{ $client->client_id }}">{{ $client->cust_code1 }}</td>
    <td class="clients_col_company" id="clients_col_id_{{ $client->client_id }}">
            {{ str_limit($client->client_company_name, 35) }}
    ...
    <td class="clients_col_action actions_column" id="clients_col_action_{{ $client->client_id }}">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="{{ cleanLang(__('lang.delete')) }}" class="data-toggle-action-tooltip btn btn-outline-danger btn-circle btn-sm confirm-action-danger"
                ...
                data-ajax-type="DELETE" data-url="{{ url('/clients/'.$client->client_id) }}">
