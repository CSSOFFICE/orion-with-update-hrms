...
<div class="invoice-item-actions">
    ...
    <!--add blank line-->
    {{-- <button type="button" id="billing-item-actions-blank" class="btn btn-secondary btn-rounded btn-sm btn-rounded-icon"><i
            class="mdi mdi-plus-circle-outline text-themecontrast"></i>
        <span>{{ cleanLang(__('lang.new_blank_line')) }}</span></button> --}}

    <!--add time line-->
    {{-- <button type="button" id="billing-time-actions-blank" class="btn btn-secondary btn-rounded btn-sm btn-rounded-icon"><i
            class="mdi mdi-plus-circle-outline text-themecontrast"></i>
        <span>{{ cleanLang(__('lang.new_time_line')) }}</span></button> --}}



    {{-- <button type="button" id="billing-product-actions-blankg"
