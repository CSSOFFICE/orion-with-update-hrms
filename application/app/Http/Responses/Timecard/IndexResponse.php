...
namespace App\Http\Responses\Timecard;
...
class IndexResponse implements Responsable
{
    ...
    public function toResponse($request)
    {
        ...
        for ($day = 1; $day <= $numberOfDays; $day++) {
            ...
            $currentDate = date('d', mktime(0, 0, 0, $month, $day, $year));
            $WW= date('D', mktime(0, 0, 0, $month, $day, $year));
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            switch (request('action')) {
                ...
                case 'load':
                    $template = 'pages/timecard/components/table/ajax';
                ...
                case 'search':
                    $template = 'pages/timecard/components/table/table';
                ...
                default:
                    $template = 'pages/timecard/tabswrapper';
            ...
            $html = view($template, compact('page', 'timesheets','dayy','bigarray','W','emph','dayyr'))->render();
            ...
            return view('pages/timecard/wrapper', compact('page', 'timesheets','dayy','bigarray','W','emph','dayyr'))->render();
        }
    }
}
