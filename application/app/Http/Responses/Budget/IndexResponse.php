    ...
    public function toResponse($request)
    {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            switch (request('action')) {
                ...
                case 'load':
                    $template = 'pages/budget/components/table/ajax';
                ...
                case 'search':
                    $template = 'pages/budget/components/table/table';
                ...
                default:
                    $template = 'pages/budget/tabswrapper';
            ...
            $html = view($template, compact('page', 'notes', 'grn_data', 'templete_category'))->render();
            ...
            return view('pages/budget/wrapper', compact('page', 'notes', 'grn_data', 'templete_category'))->render();
        }
    }
}
