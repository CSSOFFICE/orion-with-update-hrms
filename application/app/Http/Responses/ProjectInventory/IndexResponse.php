...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/projectinventory/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/projectinventory/components/table/table';
            ...
            default:
                $template = 'pages/projectinventory/tabswrapper';
            ...
            $html = view($template, compact('page', 'notes','grn_data','stock_move_data','project_id'))->render();
            ...
            return view('pages/projectinventory/wrapper', compact('page', 'notes','grn_data','stock_move_data','project_id'))->render();
        }
