        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            switch (request('action')) {
                ...
                case 'load':
                    ...
                    $template1 = 'pages/clients/components/tables/ajax';
                ...
                case 'search':
                    $template1 = 'pages/clients/components/tables/table';
            ...
            if ($cust_type == 1) {
                ...
                $html = view($template, compact('page', 'stats', 'clients', 'cust_type'))->render();
                $jsondata['dom_html'][] = array(
                ...
                $html = view($template1, compact('page', 'stats', 'clients', 'cust_type'))->render();
                $jsondata['dom_html'][] = array(
                    'selector' => $dom_container,
                    'action' => $dom_action,
                    'value' => $html
            ...
            return view('pages/clients/wrapper', compact('page', 'stats', 'clients', 'categories', 'tags', 'cust_type'))->render();
        }
    }
}
