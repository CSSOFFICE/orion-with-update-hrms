...
class CreateResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //render the form
        $html = view('pages/invoices/components/modals/add-edit-inc', compact('page','project', 'tags','payment_terms','gst','client','quotation','total_invoice_amount','grn_data','templete_category'))->render();
