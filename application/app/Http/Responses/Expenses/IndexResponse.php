...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            $html = view($template, compact('page', 'expenses', 'stats', 'categories', 'projects','expenses_data'))->render();
            ...
            return view('pages/expenses/wrapper', compact('page', 'expenses', 'stats', 'categories', 'projects','expenses_data'))->render();
        }
