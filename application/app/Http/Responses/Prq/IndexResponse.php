    ...
    public function toResponse($request)
    {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            switch (request('action')) {
                ...
                case 'load':
                    $template = 'pages/prq/components/table/ajax';
                ...
                case 'search':
                    $template = 'pages/prq/components/table/table';
                ...
                default:
                    $template = 'pages/prq/tabswrapper';
            ...
            $html = view($template, compact('page', 'notes', 'grn_data'))->render();
            ...
            return view('pages/prq/wrapper', compact('page', 'notes', 'grn_data'))->render();
        }
    }
}
