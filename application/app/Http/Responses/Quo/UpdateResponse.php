...
class UpdateResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        $html = view('pages/quos/components/table/ajax', compact('quo'))->render();
        ...
        if (isset($type) && $type == 'update-assigned') {
            ...
            $html = view('pages/quo/components/assigned', compact('quo', 'assigned'))->render();
            $jsondata['dom_html'][] = array(
                'selector' => "#task-assigned-container",
                'action' => 'replace',
                'value' => $html);
            //update timer section
            $html = view('pages/quo/components/timer', compact('quo'))->render();
            $jsondata['dom_html'][] = array(
