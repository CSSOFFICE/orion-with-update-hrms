...
class IndexListResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'load':
                $template = 'pages/quos/components/table/ajax';
            ...
            case 'search':
                $template = 'pages/quos/components/table/table';
            ...
            return view($template, compact('page','quos', 'tasks','stats', 'tags', 'milestones'))->render();
        }
    }
}
