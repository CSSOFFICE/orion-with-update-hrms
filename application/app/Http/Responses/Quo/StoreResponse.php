...
class StoreResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (auth()->user()->pref_view_tasks_layout == 'list') {
            if ($count == 1) {
                $html = view('pages/quos/components/table/table', compact('tasks'))->render();
                ...
                $html = view('pages/quos/components/table/ajax', compact('tasks'))->render();
                $jsondata['dom_html'][] = array(
        ...
        //     $jsondata['redirect_url'] = url("/quo/v/" . $task->task_id . "/" . str_slug($task->task_title));
        // }
