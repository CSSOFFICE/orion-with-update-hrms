...
class IndexKanbanResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            case 'sort':
                $template = 'pages/quos/components/kanban/wrapper';
            ...
            default:
                $template = 'pages/quos/tabswrapper';
            ...
            if (request('action') == 'load') {
                ...
                if (request()->filled('source')) {
                    $name = request('source');
                    $board = $boards[$name];
                    $html = view('pages/quos/components/kanban/card', compact('board'))->render();
                ...
                $html = view($template, compact('page', 'boards', 'stats', 'tags', 'milestones','tasks'))->render();
                $jsondata['dom_html'][] = array(
            ...
            //standard view
            return view('pages/quos/wrapper', compact('page', 'boards', 'stats', 'tags', 'milestones','tasks'))->render();
        }
    }
}
