...
/** --------------------------------------------------------------------------------
 * This classes renders the response for the [attach] process for the Variation
 * controller
 * @package    Grow CRM
 * @author     NextLoop
 *----------------------------------------------------------------------------------*/
...
class AttachProjectResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //render the form
        $html = view('pages/variation/components/actions/attach-project', compact('payload'))->render();
