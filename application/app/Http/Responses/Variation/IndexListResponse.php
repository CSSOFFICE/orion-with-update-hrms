...
class IndexListResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            $html = view($template, compact('page', 'tasks', 'stats', 'tags', 'estimates','categories'))->render();
            ...
            $template = 'pages/estimates/wrapper';
            //standard view
            ...
            return view($template, compact('page','estimates', 'tasks', 'stats', 'tags','categories' ))->render();
        }
    }
}
