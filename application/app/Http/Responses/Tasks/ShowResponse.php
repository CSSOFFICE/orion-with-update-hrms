...
class ShowResponse implements Responsable
{
    ...
    public function toResponse($request)
    {
        ...
        // RIGHT PANEL---
        $html = view('pages/task/rightpanel', compact('page', 'task', 'assigned', 'milestones', 'project_assigned'))->render();
        ...
        $html = view('pages/task/components/subtask', compact('subb'))->render();
        $jsondata['dom_html'][] = array(
            'selector' => '#card-subtask-container',
            'action' => 'replace',
            'value' => $html
        );
