    ...
    private function fronteEnd($project = '')
    {
        ...
        if ($this->projectpermissions->check('view', $project)) {
            config([
                ...
                'settings.project_permissions_view_variation_order' => $this->projectpermissions->check('vo-view', $project),
                'settings.project_permissions_view_inventary' => $this->projectpermissions->check('inventary-view', $project),
                'settings.project_permissions_view_prq' => $this->projectpermissions->check('prq-view', $project),
                'settings.project_permissions_view_budget' => $this->projectpermissions->check('budget-view', $project),
            ]);
        }
