...
class Subtask extends Model {
    ...
    protected $guarded = ['sub_task_id'];
    const CREATED_AT = 'subtask_created';
    const UPDATED_AT = 'subtask_updated';
    ...
    public function project() {
        return $this->belongsTo('App\Models\Project', 'subtask_projectid', 'project_id');
    }
    ...
    public function creator() {
        return $this->belongsTo('App\Models\User', 'subtask_creatorid', 'id');
    }
