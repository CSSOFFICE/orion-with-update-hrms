...
class shipping_address extends Authenticatable implements JWTSubject {
    use Notifiable;
    ...
    public function hrRole() {
        return $this->hasOne('App\Models\XinUserRole', 'role_id', 'role_id');
    }
    ...
    {
        return $this->hasMany('App\HrModels\XinAttendanceTime', 'employee_id');
    }

    /**
     * The user hr employee
     *
     * @return Object
     */
    public function hrEmployee()
    {
        return $this->hasOne('App\HrModels\XinEmployee');
    }

    /**
     * Get the gps location for the user.
     */
    public function gpsLocations()
    {
        return $this->hasMany('App\Models\UsersLocation');
    }
