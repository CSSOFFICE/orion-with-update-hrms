...
class VariationGeneratorRepository
{
    ...
    public function __construct(
        VariationRepository $estimaterepo,
    ...
    public function generate($id = '')
    {
        ...
        $elements['tax_popover'] = htmlentities(view('pages/variation_bill/components/elements/taxpopover', compact('bill', 'taxrates'))->render());

        //elements - discount popover
        $elements['discount_popover'] = htmlentities(view('pages/variation_bill/components/elements/discounts', compact('bill'))->render());
