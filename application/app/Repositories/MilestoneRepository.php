...
class MilestoneRepository
{
    ...
    //     $milestones=DB::table('milestone_categories');
    ...
    //                                          FROM tasks
    //                                          WHERE task_cat_id = milestone_categories.milestonecategory_id)
    ...
    //         DB::table('tasks')->where('task_projectid', request('filter_milestone_projectid'));
    //     }

    //     //filters: id
    //     if (request()->filled('filter_milestone_id')) {
    //         DB::table('tasks')->where('task_projectid', request('filter_milestone_id'));
    //     }
    //     if (is_numeric($id)) {
    //         DB::table('tasks')->where('task_projectid', $id);
    //     }

    //     //sorting
    //     if (in_array(request('sortorder'), array('desc', 'asc')) && request('orderby') != '') {
    //         //direct column name
    //         if (Schema::hasColumn('milestone_categories', request('orderby'))) {
    ...
    //     } else {
    //         //default sorting
    //         $milestones->orderBy('milestonecategory_id', 'asc');
    //     }
    ...
    public function get_milestone($id)
    {
        ...
        $usersWithRoles = DB::table('estimates')
            ...
            ->where('estimates.bill_projectid', $id)
