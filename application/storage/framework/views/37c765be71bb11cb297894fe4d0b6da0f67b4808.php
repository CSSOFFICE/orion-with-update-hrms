   ...
   <!-- BILL CONTENT -->
    ...
    <?php if(!empty($option)): ?>
        <?php if($option === 'summary'): ?>
            ...
            <button class="btn btn-secondary m-r-10 option-button" data-template="<?php echo e($option); ?>"><?php echo e($option); ?></button>
        <?php else: ?>
        <button class="btn btn-primary m-r-10 option-button" data-template="<?php echo e($option); ?>"><?php echo e($option); ?></button>
        <?php endif; ?>
    <?php endif; ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/bill/wrapper.blade.php ENDPATH**/ ?>