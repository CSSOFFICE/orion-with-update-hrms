...
<div class="col-md-12  col-lg-5 align-self-center text-right p-b-9  <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" data-toggle="tooltip"
            title="<?php echo e(cleanLang(__('lang.publish_revised_estimate'))); ?>"
            class="list-actions-button btn btn-page-actions waves-effect waves-dark confirm-action-info"
        ...
        <?php endif; ?>
        <?php if($bill->bill_status == 'accepted'): ?>
        <button type="button"
            ...
            data-url="<?php echo e(urlResource('/estimates/' . $bill->bill_estimateid . '/add-form')); ?>"
            data-action-url="<?php echo e(urlResource('/estimates/' . $bill->bill_estimateid . '/add-form')); ?>"
            data-loading-target="actionsModalBody" data-action-method="POST">
            <i class="fa fa-plus-square-o" aria-hidden="true"></i>
        </button>
        <?php endif; ?>
        <?php if($bill->bill_status == 'waiting_for_approvall'): ?>
        ...
        <button type="button" data-toggle="tooltip" title="Approved From Management"
            ...
            value="<?php echo e($bill->bill_estimateid); ?>"><i class="ti-thumb-up"></i></button>
        ...
        <!--edit-->
        <span class="dropdown">
            <button type="button" data-toggle="dropdown" id="defaultneed" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                href="<?php echo e(url('project/' . $bill->bill_projectid . '/estimates/'.$bill->vo_id)); ?>/edit-estimate">Edit Variation Order</a>
                <!--attach project-->
                <a class="dropdown-item confirm-action-danger hidden <?php echo e(runtimeVisibility('dettach-estimate', $bill->bill_projectid)); ?>"
                ...
                <!--deattach project-->
                <a class="dropdown-item hidden actions-modal-button js-ajax-ux-request reset-target-modal-form <?php echo e(runtimeVisibility('attach-estimate', $bill->bill_projectid)); ?>"
        ...
        <button type="button" data-toggle="tooltip" title="Delete Quotation"
            ...
            data-confirm-title="Delete Quotation" data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>"
        ...
        <script>
            $('#status_change').on('click', function() {
                ...
                $.ajax({
                    url: "<?php echo e(urlResource('/estimates/' . $bill->bill_estimateid . '/change-status')); ?>",
                    type: "POST",
                    data: {
                        iiid: this.value,
                        _token: csrf_token
        ...
        <a href="<?php echo e(url('/')); ?>/estimates/export-quotation/<?php echo e($bill->bill_estimateid); ?>"
        data-toggle="tooltip" id="download-button" title="<?php echo e(cleanLang(__('lang.download'))); ?>"
...
<?php /**PATH C:\xampp\htdocs\Orion\application\resources\views/pages/variation_bill/components/misc/estimate/actions.blade.php ENDPATH**/ ?>