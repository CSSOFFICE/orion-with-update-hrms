                ...
                <div class="d-flex m-b-30">
                    ...
                    <div class="ml-auto align-self-center">
                        <ul class="list-inline font-12">
                            <li><i class="fa fa-circle text-success"></i> <?php echo e(cleanLang(__('lang.income'))); ?></li>
                            <li><i class="fa fa-circle text-info"></i> <?php echo e(cleanLang(__('lang.expense'))); ?></li>
                        </ul>
                    </div>
                </div>
    ...
    </script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/home/admin/widgets/second-row/income.blade.php ENDPATH**/ ?>