...
<tr id="client_<?php echo e($client->client_id); ?>">
    <td class="clients_col_id" id="clients_col_id_<?php echo e($client->client_id); ?>"><?php echo e($client->cust_code1); ?></td>
    <!-- <td class="clients_col_company" id="clients_col_id_<?php echo e($client->client_id); ?>">
            <?php echo e(str_limit($client->client_company_name, 35)); ?>

        <a href=<?php echo e(url("/clients/")); ?>/<?php echo e($client->client_id ?? ''); ?>><?php echo e(str_limit($client->client_company_name, 35)); ?></a>
    </td> -->
    <td class="clients_col_company" id="clients_col_id_<?php echo e($client->client_id); ?>">

        <span><?php echo e($client->f_name ?? '---'); ?></span>
    </td>   
    <td class="clients_col_company" id="clients_col_id_<?php echo e($client->client_id); ?>">
            <?php echo e(str_limit($client->client_phone)); ?>

    </td>
    <td class="clients_col_company" id="clients_col_id_<?php echo e($client->client_id); ?>">
            <?php echo e(str_limit($client->u_email, 35)); ?>
    ...
    <td class="clients_col_action actions_column" id="clients_col_action_<?php echo e($client->client_id); ?>">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <?php endif; ?>
            <a href="<?php echo e(url('/clients/'.$client->client_id) ?? ''); ?>" class="btn btn-outline-info btn-circle btn-sm">
...
<!--each row--><?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/clients/components/table/ajax.blade.php ENDPATH**/ ?>