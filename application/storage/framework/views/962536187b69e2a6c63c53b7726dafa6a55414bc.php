...
<div class="row" id="js-trigger-expenses" data-client-id="<?php echo e($expense->expense_clientid ?? ''); ?>"
    ...
    <!--product invoice Numberr-->
    <!-- <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required">Purchase Invoice Number <span>*</span></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" name="purchase_invoice_no" value="<?php echo e($expense->purchase_invoice_no ?? ''); ?>">
            </div>
        </div> -->
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label">Purchase Order </label>
            <div class="col-sm-12 col-lg-9">
                <select class="select2-basic form-control form-control-sm" id="porder_id"
                    name="porder_id">
                    ...
                    <option value="<?php echo e($po->purchase_order_id); ?>"
                        <?php echo e(runtimePreselected($expense->purchase_order_no ?? '', $po->purchase_order_id)); ?>><?php echo e(runtimeLang($po->porder_id)); ?></option>
         ...
         <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.letter_of_award'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <div class="input-group input-group-sm">
                    <input type="text" name="letter_of_award" id="letter_of_award" class="form-control form-control-sm"
                        value="<?php echo e($expense->letter_of_award ?? ''); ?>" aria-describedby="basic-addon2">
                </div>
            </div>
        </div>
        ...
        <div class="form-group form-group-checkbox row" id="expense_billable_option">
            <label class="col-sm-12 col-lg-3 col-form-label text-left"><?php echo e(cleanLang(__('lang.petty_cash'))); ?>?</label>
                    ...
                    <div class="dropzone dz-clickable" id="fileupload_expense_receipt">
                        <div class="dz-default dz-message">
                            <i class="icon-Upload-toCloud   "></i>
                                <input type="file" class="icon-Upload-toCloud">
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('change','#porder_id',function(){
            var order_num = $('#porder_id').val();

            $.ajax({
                type:'POST',
                url:'<?php echo e(url("/onchange_amount")); ?>',
                data : {'order_num':order_num,_token},
        ...
        // $('#commonModalForm').attr('enctype');
    });
</script>
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/expenses/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>