<div class="col-12 align-self-center hidden checkbox-actions  box-shadow-minimum" id="invoices-checkbox-actions-container">
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger"
            data-type="form" data-ajax-type="DELETE" data-form-id="invoices-list-table"
...
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/invoices/components/actions/checkbox-actions.blade.php ENDPATH**/ ?>