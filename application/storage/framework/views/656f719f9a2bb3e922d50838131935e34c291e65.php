        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="list-inline m-t-30 text-center font-12">
                    ...
                    <li><i class="fa fa-circle <?php echo e($lead_status['color']); ?>"></i> <?php echo e($lead_status['title']); ?></li>
    ...
    </script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/home/admin/widgets/second-row/leads.blade.php ENDPATH**/ ?>