<div class="row">
    <div class="col-lg-12">
        ...
        <!--due date-->
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.start_date'))); ?></label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.end_date'))); ?></label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.assign_users'))); ?> <a
                    class="align-middle font-16 toggle-collapse" href="#assigning_info" role="button"
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.sub_con'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="sub_con" name="sub_con"
                    placeholder="">
            </div>
        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/tasks/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>