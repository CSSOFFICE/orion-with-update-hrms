...
<div class="row" id="js-trigger-expenses" data-client-id="<?php echo e($expense->expense_clientid ?? ''); ?>"
    ...
    <div class="col-lg-12">
        <?php if(config('visibility.expenses_col_project_op')): ?>
            ...
            <div class="col-sm-12 col-lg-9">
                <select class="form-control form-control-sm" id="porder_id" name="porder_id" data-plugin="select_hrm">
                    ...
                    <option value="<?php echo e($po->purchase_order_id); ?>"
                        <?php echo e(runtimePreselected($expense->purchase_order_no ?? '', $po->purchase_order_id)); ?>>
                        <?php echo e(runtimeLang($po->porder_id)); ?>
        ...
        <?php if(config('visibility.expenses_col_project_op')==null): ?>
        <input type="hidden" value="<?php echo e(request('expenseresource_id')); ?>" name="expense_projectid"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm pickadate" autocomplete="off"
                    name="expense_date" value="<?php echo e(date('d-m-Y')); ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" name="invoice"
                    value="<?php echo e($expense->purchase_invoice_no ?? ''); ?>">
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="dropzone dz-clickable text-center file-upload-box" id="fileupload_expense_receipt">
                    <div class="dz-default dz-message">
                        ...
                        <div class="p-t-10"><small><?php echo e(cleanLang(__('lang.allowed_file_types'))); ?>: (jpg|png)</small>
                        </div>
                        <div class=""><small><?php echo e(cleanLang(__('lang.best_image_dimensions'))); ?>: (185px X
                                45px)</small></div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/expenses/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>