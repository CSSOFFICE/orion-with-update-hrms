...
<div class="col-md-12 <?php echo e(runtimeCrumbsColumnSize($page['crumbs_col_size'] ?? '')); ?> align-self-center <?php echo e($page['crumbs_special_class'] ?? ''); ?>" id="breadcrumbs">
    ...
    <div class="d-flex">
        <button type="button" class="btn btn-bg-light m-1 border-primary" onclick="abc(1)">Individual</button>
        <button type="button" class="btn btn-bg-light m-1 border-primary" onclick="abc(0)">Company</button>
    </div>
    <?php endif; ?>
</div>
...
<?php endif; ?>
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/misc/heading-crumbs.blade.php ENDPATH**/ ?>