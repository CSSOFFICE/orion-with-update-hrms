<!--modal-->
<div class="modal" role="dialog" aria-labelledby="foo" id="commonModal" enctype="multipart/form-data"<?php echo clean(runtimeAllowCloseModalOptions()); ?>>
    <div class="modal-dialog" id="commonModalContainer">
        <form action="" method="post" id="commonModalForm" class="form-horizontal">
            <div class="modal-content">
                ...
                <div class="modal-footer" id="commonModalFooter hidden">
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/modals/common-modal-wrapper.blade.php ENDPATH**/ ?>