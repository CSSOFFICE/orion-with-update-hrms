...
<table style="border: 1px solid black;!important;">
    <thead style="text-align:center;">
        ...
        <tr>
            ...
            <th
                style="text-align:center;background-color:#FEF2CB;border-right:5px solid black;border-left:5px solid black;">
                <strong>$ <?php echo e(number_format($quotation_data['OTHERS']['amount'], 2)); ?></strong></th>
        </tr>
        <tr>
            <th style="border-right:5px solid black;border-left:1px solid black;"></th>
            <th style="border-right:5px solid black;border-left:1px solid black;"></th>
    ...
    <tbody>
        <?php
            ...
            $rowIndex = 1;
        ?>
        <?php $__currentLoopData = $quotation_data['OTHERS']['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <tfoot>
        <tr>
            ...
            <td
                ...
                $ <?php echo e(number_format($quotation_data['OTHERS']['total'], 2)); ?></td>
            <td
                style="text-align:center;border:1px solid black;">
                $ <?php echo e(number_format($quotation_data['OTHERS']['amount'], 2)); ?></td>
        </tr>
        <tr>
            <td style="text-align:center;border:1px solid black;width: 80px;">
...
<?php /**PATH C:\xampp\htdocs\orion\application\resources\views/pages/bill/components/export/others.blade.php ENDPATH**/ ?>