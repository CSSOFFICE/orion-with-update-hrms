...
<table style="border: 1px solid black;!important;">
    ...
    <tbody>
        <?php $__currentLoopData = $quotation_data['INSURANCES']['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
    ...
    <tfoot>
        <tr>
            ...
            <td
                ...
                $ <?php echo e(number_format($quotation_data['INSURANCES']['total'], 2)); ?></td>
        </tr>
        <tr>
            <td style="text-align:center;border-top: 5px solid black;border-bottom: 5px solid black;width: 80px;">
                <strong>TOTAL</strong>
...
<?php /**PATH C:\xampp\htdocs\orion\application\resources\views/pages/bill/components/export/insurance.blade.php ENDPATH**/ ?>