    ...
    <div class="card-body p-t-0 p-b-0">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="m-t-20">
                    <div class="panel-label p-b-3"><?php echo e(cleanLang(__('lang.letter_acceptance_no'))); ?></div>
                    <div><?php echo e($project->letter_acceptance_no); ?></div>
                </div>
            </div>
...
<!-- Column --><?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/project/components/misc/details.blade.php ENDPATH**/ ?>