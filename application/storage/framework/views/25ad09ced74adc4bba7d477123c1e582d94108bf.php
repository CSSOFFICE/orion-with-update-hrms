                ...
                <thead>
                    <tr>
                        ...
                        <th class="invoices_col_id"><a class="js-ajax-ux-request js-list-sorting" id="sort_bill_invoiceid"
                                ...
                                data-url="<?php echo e(urlResource('/invoices?action=sort&orderby=bill_invoiceid&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.id'))."1"); ?><span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                        ...
                        <th class="invoices_col_action hidden"><a href="javascript:void(0)"><?php echo e(cleanLang(__('lang.action'))); ?></a></th>
                    </tr>
                </thead>
...
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/invoices/components/table/table.blade.php ENDPATH**/ ?>