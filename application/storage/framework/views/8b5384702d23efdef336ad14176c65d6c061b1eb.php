...
<tr id="expense_<?php echo e($expense->expense_id); ?>">
    ...
    <td class="expenses_col_client">
        <a
            href="/clients/<?php echo e($expense->expense_clientid); ?>"><?php echo e(str_limit($expense->client_company_name ?? $expense->f_name, 12)); ?></a>
    </td>
    <?php endif; ?>
    <!--column visibility-->
...
<!--each row--><?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/expenses/components/table/ajax.blade.php ENDPATH**/ ?>