                    ...
                    <div class="header-search pull-right"  id="header-search-items">
                        <i class="sl-icon-magnifier"></i>
                            <input type="text" class="form-control search-records list-actions-search"
                                data-url="<?php echo e(url('/items?action=search&itemresource_type=invoice')); ?>"
...
</div><?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/bill/components/modals/items.blade.php ENDPATH**/ ?>