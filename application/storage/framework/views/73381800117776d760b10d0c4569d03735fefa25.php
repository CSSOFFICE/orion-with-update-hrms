        ...
        <div class="form-group row">
            ...
            <select class="form-control" name="Billing_Address" id="Billing_Address">
                ...
                <?php foreach ($billing as $k => $billing) { ?>
                    <option value="<?php echo $billing->id; ?>"><?php echo e($billing->city); ?><?php echo e($billing->state); ?> <?php echo e($billing->country); ?> <?php echo e($billing->zipcode); ?></option>
                <?php } ?>
            </select>
        </div>
        <div class="form-group row">
            ...
            <select class="form-control" name="Shipping_Address" id="Shipping_Address">
                ...
                <?php foreach ($Shipping as $k => $Shipping) { ?>
                    <option value="<?php echo $Shipping->id; ?>"><?php echo e($Shipping->city); ?><?php echo e($Shipping->state); ?> <?php echo e($Shipping->country); ?> <?php echo e($Shipping->zipcode); ?></option>
                <?php } ?>
            </select>
        </div>
        <div class="form-group row">
                ...
                <table class="table">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th style="border: none !important;min-width:124px;">
                                <a href="javascript:void(0)" class="btn-sm btn-success"
...
<?php /**PATH C:\xampp\htdocs\orion\application\resources\views/pages/invoices/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>