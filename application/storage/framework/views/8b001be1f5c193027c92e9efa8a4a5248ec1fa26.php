            ...
            <div class="form-body">
                ...
                <div class="invoice">
                    <div class="left">
                        ...
                        <label>Task</label>
                        <select name="task_id" id="task_id" class="form-control" data-plugin="select_hrm">
                            <?php $__currentLoopData = $budgtrepo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($tas->task_cat_id==$note->mile_stone): ?>
                            <option value="<?php echo $tas->task_id; ?>" <?php echo e(($tas->task_id==$note->task)?'selected':''); ?>><?php echo $tas->task_title; ?></option>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
