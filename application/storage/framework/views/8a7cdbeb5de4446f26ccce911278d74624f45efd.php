...
<tr id="contact_<?php echo e($contact->id); ?>">
    ...
    <td class="contacts_col_first_name" id="contacts_col_first_name_<?php echo e($contact->id); ?>">
        <span class="user-avatar-container"><img src="<?php echo e($contact->avatar); ?>" alt="user"
            ...
            <span class="online-status bg-success" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.user_is_online'))); ?>"></span>
            <?php endif; ?>
        ...
        <span class="sl-icon-star text-warning p-l-5" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.account_owner'))); ?>"
    ...
    <td class="contacts_col_phone" id="contacts_col_phone_<?php echo e($contact->id); ?>"><?php echo e($contact->remarks ?? '---'); ?></td>
    ...
    <td class="contacts_col_action actions_column" id="contacts_col_action_<?php echo e($contact->id); ?>">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.delete'))); ?>"
                ...
                data-ajax-type="DELETE" data-url="<?php echo e(url('/')); ?>/contacts/<?php echo e($contact->id); ?>">
...
<!--each row-->
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/contacts/components/table/ajax.blade.php ENDPATH**/ ?>