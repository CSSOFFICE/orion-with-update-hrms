...
<tr id="invoice_<?php echo e($invoice->invoice_id); ?>">
    ...
    <td class="invoices_col_amount" id="invoices_col_amount_<?php echo e($invoice->invoice_id); ?>">
        <?php echo e(runtimeMoneyFormat($invoice->total)); ?>
...
<!--each row-->
<?php /**PATH C:\xampp\htdocs\Orion\application\resources\views/pages/invoices/components/table/ajax.blade.php ENDPATH**/ ?>