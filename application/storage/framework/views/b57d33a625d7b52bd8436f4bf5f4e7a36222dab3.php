<head>
    ...
    <script src="/css/orion/public/vendor/js/vendor.header.js?v=<?php echo e(config('system.versioning')); ?>"></script>
    ...
    <!--VENDORS CSS-->
    <link rel="stylesheet" href="/css/orion/public/vendor/css/vendor.css?v=<?php echo e(config('system.versioning')); ?>">
    ...
    <link href="/css/orion/public/css/custom.css?v=<?php echo e(config('system.versioning')); ?>" rel="stylesheet">
    ...
    <!--boot js-->
    <script src="/css/orion/public/js/core/head.js?v=<?php echo e(config('system.versioning')); ?>"></script>

    <!--[note: no sanitizing required] for this trusted content, which is added by the admin-->
    <?php echo config('system.settings_theme_head'); ?>

</head>
<?php /**PATH E:\xampp\htdocs\css\orion\application\resources\views/layout/header.blade.php ENDPATH**/ ?>