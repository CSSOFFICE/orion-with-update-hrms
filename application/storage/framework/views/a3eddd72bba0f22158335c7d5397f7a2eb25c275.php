...
<script type="text/javascript">
    document.getElementById('PDFDownloadButton').addEventListener('click', function () {
        ...
        // var summaryElement = document.getElementById('summery-table');
        // Adjust font size for better fitting
        invoiceElement.style.fontSize = '14px';
        // summaryElement.style.fontSize = '14px';

        // Clone the invoice wrapper and add footer
        // var pdfContainer = document.createElement('div');
        // pdfContainer.appendChild(invoiceElement.cloneNode(true));

        // var footer = document.createElement('div');
        // footer.classList.add('pdf-footer');
        // footer.innerHTML = "term_by_sm";
        // pdfContainer.appendChild(footer);

        var opt = {
            margin: [0.5, 0, 0.5, 0], // Increase bottom margin to fit footer
    ...
    <div class="card card-body invoice-wrapper box-shadow" id="invoice-wrapper">
        ...
        <?php if($bill->bill_type == 'invoice'): ?>
            <?php echo $__env->make('pages.variation_bill.components.elements.invoice.header-web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <?php if($bill->bill_type == 'estimate'): ?>
            <?php echo $__env->make('pages.variation_bill.components.elements.estimate.header-web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        ...
        <div class="row">
            ...
            <?php if($bill->bill_type == 'invoice'): ?>
                <div class="col-12" id="invoice-dates-wrapper">
                    <?php echo $__env->make('pages.variation_bill.components.elements.invoice.dates', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo $__env->make('pages.variation_bill.components.elements.invoice.payments', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            <?php endif; ?>
            <?php if($bill->bill_type == 'estimate'): ?>
                <div class="col-12 " id="invoice-dates-wrapper">
                    <?php echo $__env->make('pages.variation_bill.components.elements.estimate.dates', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            <?php endif; ?>


            <!--INVOICE TABLE-->
            <?php echo $__env->make('pages.variation_bill.components.elements.main-table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


            <!--[EDITING] INVOICE LINE ITEMS BUTTONS -->
            <?php if(config('visibility.bill_mode') == 'editing'): ?>
                <div class="col-12">
                    <?php echo $__env->make('pages.variation_bill.components.misc.add-line-buttons', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            <?php endif; ?>


            <!-- TOTAL & SUMMARY -->
            <?php echo $__env->make('pages.variation_bill.components.elements.totals-table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <!--INVOICE LOGIC-->
    <?php if(config('visibility.bill_mode') == 'editing'): ?>
        <?php echo $__env->make('pages.variation_bill.components.elements.logic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
...
<?php if(config('visibility.bill_mode') == 'editing'): ?>
    <table class="hidden" id="billing-line-template-plain">
        <?php echo $__env->make('pages.variation_bill.components.elements.line-plain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </table>
    <table class="hidden" id="billing-line-template-time">
        <?php echo $__env->make('pages.variation_bill.components.elements.line-time', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </table>
    <table class="hidden" id="billing-line-template-product">
        <?php echo $__env->make('pages.variation_bill.components.elements.line-product', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </table>

    <!--MODALS-->
    <?php echo $__env->make('pages.variation_bill.components.modals.items', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('pages.variation_bill.components.modals.expenses', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('pages.variation_bill.components.timebilling.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Orion\application\resources\views/pages/variation_bill/bill-web.blade.php ENDPATH**/ ?>