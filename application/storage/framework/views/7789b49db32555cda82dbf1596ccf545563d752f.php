                    ...
                    <tr>
                        ...
                        <th class="clients_col_company">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_first_name"
                                ...
                                data-url="<?php echo e(urlResource('/clients?action=sort&orderby=first_name&sortorder=asc')); ?>">Customer Name<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a></th>
                        <th class="clients_col_company">
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/clients/components/table/table.blade.php ENDPATH**/ ?>