...
<tr id="milestone_<?php echo e($milestone->milestone_id); ?>">
    ...
    <td class="milestones_col_tasks">
        <?php echo e(get_task_status($milestone->bill_projectid,$milestone->milestone_id,'ALL')); ?>

    </td>
    <td class="milestones_col_tasks_pending">

        <?php echo e(get_task_status($milestone->bill_projectid,$milestone->milestone_id,'PENDING')); ?>

    </td>
    <td class="milestones_col_tasks_completed">

        <?php echo e(get_task_status($milestone->bill_projectid,$milestone->milestone_id,'COMPLETED')); ?>
    ...
    <td class="milestones_col_action actions_column d-none">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            <?php if($milestone->milestone_position): ?>
            ...
            <span id="milestone_form_<?php echo e($milestone->milestone_id); ?>">
                <button type="button" title="<?php echo e(cleanLang(__('lang.delete'))); ?>"
                    ...
                    data-url="<?php echo e(url('/')); ?>/milestones/<?php echo e($milestone->milestone_id); ?>?project_id=<?php echo e($milestone->milestone_position); ?>">
