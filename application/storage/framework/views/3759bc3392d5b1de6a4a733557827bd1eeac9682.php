...
<table class="table table-bordered border-secondary nowrap w-100">
    ...
    <tbody id="insurance-table-body">
        <tr style="background-color:#FEF2CB">
            ...
            <th class="text-start" style="text-align:left!important;"><b>BILL NO. 2 - INSURANCES FOR THE WORKS</b></th>
...
<?php /**PATH C:\xampp\htdocs\orion\application\resources\views/pages/bill/components/elements/templates/insurance.blade.php ENDPATH**/ ?>