        ...
        <div class="table-responsive list-table-wrapper">
            ...
            <table id="tasks-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="estimates_col_id"><a class="js-ajax-ux-request js-list-sorting" id="sort_bill_estimateid"
                                ...
                                data-url="<?php echo e(urlResource('/estimates?action=sort&orderby=bill_estimateid&sortorder=asc')); ?>">Quotation No<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                ...
                <tbody id="tasks-td-container">
                    <!--ajax content here-->
                    <?php echo $__env->make('pages.quos.components.table.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!--ajax content here-->
                </tbody>
                <tfoot>
                    <tr>
...
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/quos/components/table/table.blade.php ENDPATH**/ ?>