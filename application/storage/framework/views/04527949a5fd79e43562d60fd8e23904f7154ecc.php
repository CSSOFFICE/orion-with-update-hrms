    ...
    <table class="table table-bordered border-secondary nowrap w-100">
        ...
        <tbody id="schedule-table-body">
            <tr style="background-color:#FEF2CB">
                ...
                <th class="text-start" style="text-align:left!important;"><b>BILL NO. 3 - PROPOSED BUILDING WORKS</b>
                </th>
                        ...
                        <?php elseif($data->type == 'row'): ?>
                            <tr class="fw-bold">
                                ...
                                <td>
                                    <textarea name="description[]" rows="5" class="form-control description-input" autocomplete="off"><?php echo e($data->description); ?></textarea>
                                    <br>
                                    <div class="form-control dropdown-list" style="height:auto;"></div>
                                </td>
                                <td>
                                    <select class="form-control unit-input" name="unit[]">
                                        <option value="">Select Unit</option>
        ...
        <tfoot>
            <tr id="subtotal-row" style="border-bottom: 1px solid black;border-top: 2px solid black;">
                ...
                <td id="amount-subtotal">$<?php echo e(number_format($SCW['total'], 2)); ?></td>
                <script>
            ...
            <tr style="border-bottom: 2px solid black;border-top: 1px solid black;">
                ...
                <td>$<?php echo e(number_format($SCW['total'], 2)); ?></td>
            </tr>
        </tfoot>
    </table>
</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#schedule_new_blank_line').on('click', function() {
            $('#schedule-table-body').append(getRowTemplate('row', uomOptions));
        });

        // Add new head line (appends to end)
        $('#schedule_new_head_line').on('click', function() {
            $('#schedule-table-body').append(getRowTemplate('head', uomOptions));
        });

        // Add row after specific row/head
        $('#schedule-table-body').on('click', '.add-row-after', function() {
            $(this).closest('tr').after(getRowTemplate('row', uomOptions));
        });

        // Add head after specific row/head
        $('#schedule-table-body').on('click', '.add-head-after', function() {
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/bill/components/elements/templates/schedule_of_works.blade.php ENDPATH**/ ?>