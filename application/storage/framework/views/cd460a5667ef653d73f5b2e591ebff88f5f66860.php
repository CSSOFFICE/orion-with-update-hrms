<div class="row">
    <div class="col-lg-12">
        ...
        <?php endif; ?>
        <input type="hidden" name="clientid" id="clientid" value="<?php echo e($client->client_id ?? ''); ?>">
        ...
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label required">Contact Person*</label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo e("Contact Number"); ?></label>
            <div class="col-sm-12 col-lg-9">
        ...
        <div class="form-group row d-none">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label required"><?php echo e(cleanLang(__('lang.mobile_no'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="mobile_no" name="mobile_no" value="<?php echo e($client->client_phone ?? ''); ?>" placeholder="">
            </div>
        </div>
        <div class="form-group row d-none">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label required"><?php echo e(cleanLang(__('lang.payment_type'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
            <input type="text" class="form-control form-control-sm" id="payment_type" name="payment_type" value="<?php echo e($client->payment_type ?? ''); ?>" placeholder="">
            </div>
        </div>
        <div class="form-group row d-none">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label required"><?php echo e(cleanLang(__('lang.credit_term'))); ?>*</label>
            <div class="col-sm-12 col-lg-9">
                <textarea class="form-control form-control-sm" id="credit_term" name="credit_term" placeholder=""><?php echo e($client->credit_term ?? ''); ?></textarea>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">Remarks</label>
            <div class="col-sm-12 col-lg-9">
                <textarea class="form-control form-control-sm" id="remarks" name="remarks" placeholder=""><?php echo e($user->remarks ?? ''); ?></textarea>
            </div>
        </div>
...
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/contacts/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>