...
<table style="border: 1px solid black;!important;">
    <thead style="text-align:center;">
        ...
        <tr>
            ...
            <th
                style="text-align:center;background-color:#FEF2CB;border-right:5px solid black;border-left:5px solid black;">
                <strong>$ <?php echo e(number_format($quotation_data['PRELIMINARIES']['total'], 2)); ?></strong>
            </th>
        </tr>
        <tr>
            <th style="border-right:5px solid black;border-left:1px solid black;"></th>
    ...
    <tbody>
        <?php $__currentLoopData = $quotation_data['PRELIMINARIES']['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td style="border: 1px solid black;vertical-align:top;"><?php echo e($key + 1); ?></td>
    ...
    <tfoot>
        <tr>
            ...
            <td
                ...
                $ <?php echo e(number_format($quotation_data['PRELIMINARIES']['total'], 2)); ?></td>
        </tr>
        <tr>
            <td style="text-align:center;border-top: 5px solid black;border-bottom: 5px solid black;width: 80px;">
                <strong>TOTAL</strong>
...
<?php /**PATH C:\xampp\htdocs\orion\application\resources\views/pages/bill/components/export/preliminaries.blade.php ENDPATH**/ ?>