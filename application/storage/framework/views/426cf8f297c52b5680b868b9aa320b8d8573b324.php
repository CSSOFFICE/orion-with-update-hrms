<table class="table table-bordered border-secondary">
    ...
    <tbody id="others-table-body">
        ...
        <?php if(config('visibility.bill_mode') == 'viewing'): ?>
            ...
            <?php $__currentLoopData = $quotation_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($data->template_id == 8 && $data->quotation_no == $page['crumbs'][2]): ?>
                        ...
                        <tr class="fw-bold" style="background-color:#E2EFD9">
                            ...
                            <td>
                                <select class="form-control" name="unit[]">
                                    <option value="sum" <?php echo e($data->unit == 'sum' ? 'sexternalted' : ''); ?>>Sum
                                    </option>
                                </select>
                            </td>
    ...
    <tfoot>
        <tr id="subtotal-row" style="border-bottom: 1px solid black;border-top: 2px solid black;">
            ...
            <td id="amount-subtotal">$<?php echo e(number_format($others['total'], 2)); ?></td>
            <script>
        ...
        <tr style="border-bottom: 2px solid black;border-top: 1px solid black;">
            ...
            <td>$<?php echo e(number_format($others['total'], 2)); ?></td>
        </tr>
    </tfoot>
</table>
...
<?php /**PATH C:\xampp\htdocs\Orion\application\resources\views/pages/variation_bill/components/elements/templates/others.blade.php ENDPATH**/ ?>