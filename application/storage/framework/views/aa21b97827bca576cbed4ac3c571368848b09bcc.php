                ...
                <thead>
                    <tr>
                        ...
                        <th class="invoices_col_id"><a class="js-ajax-ux-request js-list-sorting" id="sort_bill_invoiceid"
                                ...
                                data-url="<?php echo e(urlResource('/invoices?action=sort&orderby=bill_invoiceid&sortorder=asc')); ?>"><?php echo e("Invoice No"); ?><span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
...
<?php /**PATH C:\xampp\htdocs\orion\application\resources\views/pages/invoices/components/table/table.blade.php ENDPATH**/ ?>