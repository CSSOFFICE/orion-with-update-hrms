            ...
            <?php if(config('visibility.action_column')): ?>
                <td class="clients_col_action actions_column" id="clients_col_action_<?php echo e($client->client_id); ?>">
                    ...
                    <span class="list-table-action dropdown font-size-inherit">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(url('/clients/' . $client->client_id) ?? ''); ?>"
...
<!--each row-->
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/clients/components/table/ajax.blade.php ENDPATH**/ ?>