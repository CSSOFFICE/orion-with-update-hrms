                        ...
                        <tr class="fw-bold" style="background-color:#E2EFD9">
                            ...
                            <td>
                                <select class="form-control" name="unit[]">
                                    <option value="sum" <?php echo e($data->unit == 'sum' ? 'selected' : ''); ?>>Sum
                                    </option>
                                </select>
                            </td>
...
<?php /**PATH C:\xampp\htdocs\Orion\application\resources\views/pages/variation_bill/components/elements/templates/pc_ps_sums.blade.php ENDPATH**/ ?>