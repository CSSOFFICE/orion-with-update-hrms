...
<table style="border: 1px solid black;!important;">
    <thead style="text-align:center;">
        ...
        <tr>
            ...
            <th
                ...
                <b>BILL NO. 3 - PROPOSED BUILDING WORKS</b>
            </th>
            <th
            ...
            <th
                style="text-align:center;background-color:#FEF2CB;border-right:5px solid black;border-left:5px solid black;">
                <strong>$ <?php echo e(number_format($quotation_data['INSURANCES']['total'], 2)); ?></strong>
            </th>
        </tr>
        <tr>
            <th style="border-right:5px solid black;border-left:1px solid black;"></th>
    ...
    <tbody>
        <?php
            ...
            $rowIndex = 1;
        ?>
        <?php $__currentLoopData = $quotation_data['SCHEDULE OF WORKS']['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($item->type == 'head'): ?>
                <tr>
                    <td style="border: 1px solid black;vertical-align:right;background-color:#E2EFD9;"><?php echo e($letterCounter); ?></td>
                    <td style="border: 1px solid black;width: 350px; word-wrap: break-word; white-space: normal;background-color:#E2EFD9;"><?php echo e($item->description); ?></td>
                    <td style="border: 1px solid black;width: 50px;text-align:center;vertical-align:top; background-color:#E2EFD9;"></td>
                    <td style="border: 1px solid black;width: 50px;text-align:center;vertical-align:top;background-color:#E2EFD9;"></td>
                    <td style="border: 1px solid black;width: 50px;text-align:center;vertical-align:top;background-color:#E2EFD9;"></td>
                    <td style="border: 1px solid black;width: 100px;vertical-align:top;text-align:center;background-color:#E2EFD9;"></td>
                </tr>
    ...
    <tfoot>
        <tr>
            ...
            <td style="text-align:center;border:1px solid black;">
                $ <?php echo e(number_format($quotation_data['SCHEDULE OF WORKS']['total'], 2)); ?></td>
...
<?php /**PATH C:\xampp\htdocs\orion\application\resources\views/pages/bill/components/export/schedule_of_works.blade.php ENDPATH**/ ?>