    ...
    <div class="card">
        <div class="card card-body mailbox m-b-0">
            ...
            <div class="message-center dashboard-projects-admin">
                ...
                <a href="javascript:void(0)">
                    <div class="btn btn-red btn-circle"><?php echo e($payload['all_projects']['delay']); ?></div>
                    <div class="mail-contnet">
                        <h5><?php echo e("Delay"); ?></h5> <span class="mail-desc"><?php echo e(cleanLang(__('lang.assigned_to_me'))); ?>:
                            <strong><?php echo e($payload['my_projects']['completed']); ?></strong></span>
                    </div>
                </a>
            </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/home/admin/widgets/third-row/projects.blade.php ENDPATH**/ ?>