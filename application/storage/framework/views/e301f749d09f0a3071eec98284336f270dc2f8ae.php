                ...
                <div class="form-group row d-none">
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <input type="text" class="form-control form-control-sm" id="p_email" name="p_email"
                            value="<?php echo e($client->p_email ?? ''); ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <input type="text" class="form-control form-control-sm" id="p_contact" name="p_contact"
                            value="<?php echo e($client->p_contact ?? ''); ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label
                        class="col-sm-12 col-lg-3 text-left control-label col-form-label required"><?php echo e('Address'); ?></label>
                    <div class="col-sm-12 col-lg-9">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <input type="text" class="form-control form-control-sm" id="p_contact" name="p_unit"
                            value="<?php echo e($client->p_unit ?? ''); ?>">
                    </div>
                </div>
        ...
        <?php if(isset($page['section']) && $page['section'] == 'edit'): ?>
            ...
            <div id="add_client_billing_address_section" class="hiddenn">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <input type="text" class="form-control form-control-sm" id="p_email" name="p_email"
                            value="<?php echo e($address->p_email ?? ''); ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <input type="text" class="form-control form-control-sm" id="p_contact" name="p_contact"
                            value="<?php echo e($address->p_contact ?? ''); ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label
                    ...
                    <div class="col-sm-12 col-lg-9">
                        <input type="text" class="form-control form-control-sm" id="p_contact" name="p_unit"
                            value="<?php echo e($address->p_unit ?? ''); ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label
                        class="col-sm-12 col-lg-3 text-left control-label col-form-label required"><?php echo e(cleanLang(__('lang.street'))); ?></label>
                    <div class="col-sm-12 col-lg-9">
                        <input type="text" class="form-control form-control-sm" id="client_billing_street"
...
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/addressb/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>