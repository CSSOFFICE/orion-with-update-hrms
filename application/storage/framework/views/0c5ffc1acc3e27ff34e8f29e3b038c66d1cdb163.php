<table class="table table-bordered border-secondary">
    ...
    <tbody id="insurance-table-body">
        <tr style="background-color:#FEF2CB">
            ...
            <td class="text-start" style="text-align:left!important;"><b>BILL NO. 2 - INSURANCES FOR THE WORKS</b></th>
            <td class="text-start" colspan="12"><b>sum</b></td>
            <td class="text-start" style="text-align:left!important;"><b>$ <span id="grand-total" class="ins-gt"></span></b></td>
        </tr>
                ...
                <?php if($data->template_id == 2 && $data->quotation_no == $page['crumbs'][2]): ?>
                    <tr class="fw-bold">
                        ...
                        <td><input type="text" name="contractor_percent[]"
                                ...
                                style="width: 70px;" /></td>
                        <td><input type="text" name="contractor_amount[]" value="<?php echo e($data->contractor_amount); ?>"
        ...
        <tr id="subtotal-row" style="border-bottom: 1px solid black;border-top: 2px solid black;">
            ...
            <script>
                $(document).ready(function() {
                    $('.ins-gt').text('<?php echo number_format($insurance['total'], 2); ?>');
                });
            </script>
        </tr>        
...
<?php /**PATH C:\xampp\htdocs\Orion\application\resources\views/pages/variation_bill/components/elements/templates/insurance.blade.php ENDPATH**/ ?>