        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                <a class="dropdown-item"
                    href="<?php echo e(url('/estimates/' . $bill->bill_estimateid . '/edit-estimate')); ?>">Edit Quotation</a>
                <!--attach project-->
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/bill/components/misc/estimate/actions.blade.php ENDPATH**/ ?>