        ...
        <div class="form-group row">
            ...
            <select class="form-control" name="Billing_Address" id="Billing_Address">
                ...
                <?php foreach ($billing as $k => $billing) { ?>
                    <option value="<?php echo $billing->id; ?>"><?php echo e($billing->street); ?></option>
                <?php } ?>
            </select>
        </div>
        <div class="form-group row">
            ...
            <select class="form-control" name="Shipping_Address" id="Shipping_Address">
                ...
                <?php foreach ($Shipping as $k => $Shipping) { ?>
                    <option value="<?php echo $Shipping->id; ?>"><?php echo e($Shipping->street); ?></option>
                <?php } ?>
            </select>
        </div>
        <div class="form-group row">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/invoices/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>