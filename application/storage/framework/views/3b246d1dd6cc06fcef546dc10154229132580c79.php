...
<table class="table table-bordered border-secondary nowrap w-100">
    ...
    <tbody id="external-table-body">
        ...
        <?php if($data->template_id == 6 && $data->quotation_no == $page['crumbs'][2]): ?>
    ...
    <tfoot>
        <tr id="subtotal-row" style="border-bottom: 1px solid black;border-top: 2px solid black;">
            ...
            <td id="amount-subtotal">$<?php echo e(number_format($external['total'], 2)); ?></td>
            <script>
        ...
        <tr style="border-bottom: 2px solid black;border-top: 1px solid black;">
            ...
            <td>$<?php echo e(number_format($external['total'], 2)); ?></td>
        </tr>
    </tfoot>
</table>
</div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#external_new_blank_line').on('click', function() {
            $('#external-table-body').append(getRowTemplate('row', uomOptions));
        });

        // Add new head line (appends to end)
        $('#external_new_head_line').on('click', function() {
            $('#external-table-body').append(getRowTemplate('head', uomOptions));
        });

        // Add row after specific row/head
        $('#external-table-body').on('click', '.add-row-after', function() {
            $(this).closest('tr').after(getRowTemplate('row', uomOptions));
        });

        // Add head after specific row/head
        $('#external-table-body').on('click', '.add-head-after', function() {
...
<?php /**PATH C:\xampp\htdocs\orion\application\resources\views/pages/bill/components/elements/templates/external_works.blade.php ENDPATH**/ ?>