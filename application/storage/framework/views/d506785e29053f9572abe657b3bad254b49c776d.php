<table class="table table-bordered border-secondary">
    ...
    <tbody id="preliminaries-table-body">
        ...
        <?php if(config('visibility.bill_mode') == 'viewing'): ?>
            ...
            ?>
            <?php $__currentLoopData = $quotation_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <tfoot>
        <tr id="subtotal-row" style="border-bottom: 1px solid black;border-top: 2px solid black;">
            ...
            <td id="amount-subtotal">$<?php echo e(number_format($preliminaries['total'], 2)); ?></td>
            <script>
        ...
        <tr style="border-bottom: 2px solid black;border-top: 1px solid black;">
            ...
            <td>$<?php echo e(number_format($preliminaries['total'], 2)); ?></td>
        </tr>
    </tfoot>
</table>
...
<?php /**PATH C:\xampp\htdocs\Orion\application\resources\views/pages/variation_bill/components/elements/templates/preliminaries.blade.php ENDPATH**/ ?>