...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
       document.getElementById('insurance_new_blank_line').addEventListener('click', function() {
        ...
        insurancenewRow.querySelectorAll('.rate-input, .qty-input').forEach(input => {
            input.addEventListener('input', updateTotals);
        });

        insurancenewRow.querySelector('.delete-row-btn').addEventListener('click', function() {
            insurancenewRow.remove();
        });
    });
});
...
<?php /**PATH C:\xampp\htdocs\orion-ci-laravel\application\resources\views/pages/bill/components/elements/templates/insurance.blade.php ENDPATH**/ ?>