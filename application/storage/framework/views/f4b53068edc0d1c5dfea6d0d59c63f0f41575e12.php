 <?php $__env->startSection('content'); ?>
    ...
    <div class="login-logo m-t-30 p-b-5">
        <a href="javascript:void(0)" class="text-center db">
            <img src="<?php echo e(runtimeLogoLarge()); ?>" alt="Home" style="width: 200px;">
        </a>
    </div>
            ...
            <div class="form-group text-center p-b-10">
                <div class="col-xs-12">
                    <button class="btn btn-info btn-lg btn-block" id="loginSubmitButton"
                        ...
                        data-url="<?php echo e(url('login?action=initial')); ?>" data-ajax-type="POST"
                        type="submit"><?php echo e(cleanLang(__('lang.continue'))); ?></button>
                </div>
            </div>
...
<?php echo $__env->make('layout.wrapperplain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/authentication/login.blade.php ENDPATH**/ ?>