            ...
            <div class="r-panel-body">
                ...
                <div class="buttons-block">
                    ...
                    <button type="button" class="btn btn-rounded-x btn-danger js-ajax-ux-request apply-filter-button"
                        data-url="<?php echo e(urlResource('/address/search')); ?>" data-type="form" data-ajax-type="GET"><?php echo e(cleanLang(__('lang.apply_filter'))); ?></button>
                </div>
...
<!--sidebar-->
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/address/components/misc/filter-contacts.blade.php ENDPATH**/ ?>