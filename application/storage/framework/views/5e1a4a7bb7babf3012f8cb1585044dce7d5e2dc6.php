...
<div class="col-md-12  col-lg-5 align-self-center text-right p-b-9  <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        <?php if(auth()->user()->is_team && auth()->user()->role->role_estimates > 2): ?>
            ...
            <?php endif; ?>
            <?php if($bill->bill_status == 'waiting_for_approval'): ?>
            ...
            <script>
                $('#status_change').on('click', function() {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        data:{ iiid:this.value,_token:csrf_token},
...
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/bill/components/misc/estimate/actions.blade.php ENDPATH**/ ?>