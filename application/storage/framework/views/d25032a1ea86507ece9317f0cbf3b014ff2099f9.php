    ...
    <div class="modal-dialog">
        <form action="" method="post" id="actionsModalForm" class="form-horizontal">
            <div class="modal-content">
                ...
                <div class="modal-footer" id="actionsModalFooter hidden">
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/modals/actions-modal-wrapper.blade.php ENDPATH**/ ?>