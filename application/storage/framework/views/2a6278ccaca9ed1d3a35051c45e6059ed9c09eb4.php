                ...
                <thead>
                    <tr>
                        ...
                        <th class="expenses_col_client"><a class="js-ajax-ux-request js-list-sorting" id="sort_client"
                                href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/expenses?action=sort&orderby=client&sortorder=asc')); ?>">Customer<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                        <?php endif; ?>
                        <!--column visibility-->
...
</div><?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/expenses/components/table/table.blade.php ENDPATH**/ ?>