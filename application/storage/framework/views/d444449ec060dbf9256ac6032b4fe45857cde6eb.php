<!--modal-->
<div class="modal" role="dialog" aria-labelledby="reloginModal" id="reloginModal" data-keyboard="false"
        ...
        <form class="form-material form-horizontal" id="reloginForm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" id="reloginModalButton"
                        class="btn btn-rounded btn-info waves-effect text-left"
                        data-url="<?php echo e(url('/login?action=relogin')); ?>" data-loading-target="reloginModalBody"
                        data-ajax-type="POST"
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/authentication/modal/relogin.blade.php ENDPATH**/ ?>