<div class="card count-<?php echo e(@count($stock_move_data)); ?>" id="notes-table-wrapper">
    <div class="card-body">
        <div class="table-responsive">
            <?php if(@count($stock_move_data) > 0): ?>
            <table id="note-foo-addrow" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
                <thead>
                    <tr>
                        ...
                        <th class="notes_col_title">Product Qtn</th>                        
                ...
                <tbody id="notes-td-container">
                    <!--ajax content here-->
                    <?php echo $__env->make('pages.projectinventory.components.table.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!--ajax content here-->
                </tbody>
                <tfoot>
                    <tr>
            ...
            <?php endif; ?> <?php if(@count($stock_move_data) == 0): ?>
            <!--nothing found-->
...
<?php /**PATH C:\xampp\htdocs\orion\application\resources\views/pages/projectinventory/components/table/table.blade.php ENDPATH**/ ?>