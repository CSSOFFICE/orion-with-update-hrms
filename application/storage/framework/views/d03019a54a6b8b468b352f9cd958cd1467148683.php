<table class="table table-bordered border-secondary">
    ...
    <tbody id="plumbing-table-body">
        <tr style="background-color:#FEF2CB">
            ...
            <th class="text-start" style="text-align:left!important;"><b>BILL NO. 4 - PROPOSED PLUMBING & SANITARY WORKS</b></th>
            <th class="text-start" colspan="12"></th>            
            <th class="text-start" style="text-align:left!important;">$<span id="grand-total"class="plumbing-gt"></span></th>
        </tr>
...
<?php /**PATH C:\xampp\htdocs\Orion\application\resources\views/pages/variation_bill/components/elements/templates/plumbing_sanity.blade.php ENDPATH**/ ?>