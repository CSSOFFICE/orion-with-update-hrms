...
<div class="kanban-card show-modal-button reset-card-modal-form js-ajax-ux-request" data-toggle="modal"
    ...
    <div class="x-meta">
        ...
        <label class="label <?php echo e(runtimeTaskPriorityColors($task->task_priority, 'label')); ?> p-t-3 p-b-3 p-l-8 p-r-8"
            data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.priority'))); ?>"><?php echo e(runtimeLang($task->task_priority)); ?></label>
        <?php endif; ?>
        <!--date created-->
    ...
    <div class="x-footer row">
        <div class="col-6 x-icons">
            ...
            <span class="x-icon" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.client'))); ?> - <?php echo e(cleanLang(__('lang.hidden'))); ?>" data-placement="top"><i
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/tasks/components/kanban/card.blade.php ENDPATH**/ ?>