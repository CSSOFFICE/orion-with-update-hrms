    ...
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <select name="payment_invoiceid" id="payment_invoiceid" class="form-control pyment_option" data-plugin="select_hrm">
                    <option value="">Select Invoice</option>
                    <?php $__currentLoopData = $invoice_li; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($invoice->invoice_id); ?>" data-value="<?php echo e($invoice->total); ?>"><?php echo e($invoice->invoice_no); ?></option>
...
<script>
    $(document).ready(function() {
        ...
        $('.pyment_option').on("change", function() {
            var selectedValue = $(this).val();

            // Get the data-id attribute of the selected option
            var dataId = $('.pyment_option option:selected').data('value');

            $("#payment_amount").val(dataId)

        })

    })
</script>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/payments/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>