<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum" id="addressb-checkbox-actions-container">
    <!--button-->
    ...
    <div class="x-buttons">
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger"
            ...
            data-url="<?php echo e(url('/address/delete?type=bulk')); ?>" data-confirm-title="<?php echo e(cleanLang(__('lang.delete_selected_items'))); ?>"
...
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/addressb/components/actions/checkbox-actions.blade.php ENDPATH**/ ?>