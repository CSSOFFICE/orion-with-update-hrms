...
<tr class="billing-line-item" id="lineitem_<?php echo e($lineitem->lineitem_id ?? ''); ?>" type="plain">
    ...
    <td class="x-quantity "><input class="form-control item" name="item[<?php echo e($lineitem->lineitem_id ?? ''); ?>]" value="<?php echo e($lineitem->item ?? ''); ?>" /> </td>

    <!--description-->
    <td class="form-group x-description bill_col_description">
        <textarea class="form-control babag  form-control-sm js_item_description js_line_validation_item" rows="3"
...
<!--/#EACH LINE ITEM-->
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/bill/components/elements/line-plain.blade.php ENDPATH**/ ?>