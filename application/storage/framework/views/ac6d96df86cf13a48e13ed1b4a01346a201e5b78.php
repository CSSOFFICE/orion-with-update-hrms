...
<div class="container-fluid <?php echo e($page['mode'] ?? ''); ?>" id="invoice-container">
    ...
    <div style="margin: 0 auto;">
        ...
        <button class="btn btn-primary  m-r-10 option-button" data-template="<?php echo e($option); ?>"
            ...
            <?php echo e('Preliminaries'); ?>

            <?php elseif($option == 'insurance'): ?>
            <?php echo e('Insurance'); ?>
...
<?php echo $__env->make('layout.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/orion/application/resources/views/pages/bill/wrapper.blade.php ENDPATH**/ ?>