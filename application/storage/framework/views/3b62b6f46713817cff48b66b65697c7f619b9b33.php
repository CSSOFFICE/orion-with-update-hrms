        ...
        <div class="form-group row" >
            ...
            <div class="col-sm-12 col-lg-9">
                <select class="form-control form-control-sm" id="quotation_options" name="quotation_options">
                    ...
                    <option value="elec_acme">ELEC & ACME</option>
                    <option value="plumbing_sanity">Plumbing & Sanity</option>
...
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/quos/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>