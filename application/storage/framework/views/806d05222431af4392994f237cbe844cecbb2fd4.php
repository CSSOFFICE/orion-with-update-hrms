...
<!--fileupload-->
<!--pass source-->
<input type="hidden" name="source" value="<?php echo e(request('source')); ?>"><?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/files/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>