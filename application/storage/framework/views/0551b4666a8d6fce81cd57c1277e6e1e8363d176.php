...
<table style="border: 1px solid black;!important;">
    <thead style="text-align:center;">
        <tr style="border: 1px solid black;;">
            ...
            <th style="text-align:center;vertical-align:middle;border:5px solid black;height:50px;"><b>Amount</b></th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th
                style="text-align:left!important;word-wrap: break-word;background-color:#FEF2CB;border-right:5px solid black;border-left:5px solid black;">
                <b>Provide the following Prime Cost &amp; Provisional Sums for works to be executed by Nominated Suppliers &amp; Sub-Contractors or expended by Architect as directed. The sums shall be adjusted in due course.</b>
            </th>
            <th
            ...
            <th
                style="text-align:center;background-color:#FEF2CB;border-right:5px solid black;border-left:5px solid black;">
                <strong>$ <?php echo e(number_format($quotation_data['PC & PS SUMS']['amount'], 2)); ?></strong>
            </th>
        </tr>
        <tr>
            <th style="border-right:5px solid black;border-left:1px solid black;"></th>
    ...
    <tbody>
        <?php
            ...
            $rowIndex = 1;
        ?>
        <?php $__currentLoopData = $quotation_data['PC & PS SUMS']['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($item->type == 'head'): ?>
                <tr>
                    <td style="border: 1px solid black;vertical-align:top;background-color:#84eab3;text-align:right;"><?php echo e($letterCounter); ?>

                    </td>
                    <td style="border: 1px solid black;vertical-align:top;background-color:#84eab3">
                        <?php echo e($item->description); ?></td>
                    <td style="border: 1px solid black;vertical-align:top;background-color:#84eab3"></td>
                    <td style="border: 1px solid black;vertical-align:top;background-color:#84eab3"></td>
                    <td style="border: 1px solid black;vertical-align:top;background-color:#84eab3"></td>
                    <td style="border: 1px solid black;vertical-align:top;background-color:#84eab3"></td>
    ...
    <tfoot>
        <tr>
            ...
            <td style="text-align:center;border:1px solid black;">
                $ <?php echo e(number_format($quotation_data['PC & PS SUMS']['total'], 2)); ?></td>
            <td style="text-align:center;border:1px solid black;">
                $ <?php echo e(number_format($quotation_data['PC & PS SUMS']['amount'], 2)); ?></td>
        </tr>
        <tr>
            <td style="text-align:center;border:1px solid black;width: 80px;">
                <strong>TOTAL</strong>
...
<?php /**PATH C:\xampp\htdocs\orion\application\resources\views/pages/bill/components/export/pc_ps_sums.blade.php ENDPATH**/ ?>