...
$quotation_templates = DB::table('variation_templates')
    ...
    ->where('estimates_id', request()->segment(4))
    ->groupBy('template_id')
    ->get();
    ...
    <tbody>
        ...
        if ($template->template_id >= 1 && $template->template_id <= 6) {
            ...
            <tr class="fw-bold">
                ...
                <td style="border-top: 2px solid #000; border-bottom: 2px solid #000;"><strong>$ <?php echo e(number_format($sum2+$sum+0.05*$sum, 2)); ?></strong></td>
            </tr>
    </tbody>
</table>
<?php /**PATH C:\xampp\htdocs\Orion\application\resources\views/pages/variation_bill/components/elements/templates/summary.blade.php ENDPATH**/ ?>