...
<!--each row-->
<tr id="invoice_<?php echo e($invoice->invoice_id); ?>">
    <?php if(config('visibility.invoices_col_checkboxes')): ?>
    <td class="invoices_col_checkbox checkitem" id="invoices_col_checkbox_<?php echo e($invoice->invoice_id); ?>">
        <!--list checkbox-->
        <span class="list-checkboxes display-inline-block w-px-20">
            <input type="checkbox" id="listcheckbox-invoices-<?php echo e($invoice->invoice_id); ?>"
                name="ids[<?php echo e($invoice->invoice_id); ?>]"
            ...
            <label for="listcheckbox-invoices-<?php echo e($invoice->invoice_id); ?>"></label>
        </span>
    </td>
    <?php endif; ?>
    ...
    <td class="invoices_col_date" id="invoices_col_date_<?php echo e($invoice->invoice_id); ?>">
        <?php echo e(runtimeDate($invoice->invoice_date)); ?>
    ...
    <td class="invoices_col_amount" id="invoices_col_amount_<?php echo e($invoice->invoice_id); ?>">
        <?php echo e(runtimeMoneyFormat($invoice->total)); ?></td>
    <?php if(config('visibility.invoices_col_payments')): ?>
    <td class="invoices_col_payments" id="invoices_col_payments_<?php echo e($invoice->invoice_id); ?>">
        <a
            href="<?php echo e(url('payments?filter_payment_invoiceid='.$invoice->bill_invoiceid)); ?>"><?php echo e(runtimeMoneyFormat($invoice->total)); ?></a>
    </td>
    <?php endif; ?>
    ...
    <td class="invoices_col_action actions_column" id="invoices_col_action_<?php echo e($invoice->invoice_id); ?>">
        <!--action button-->
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <a title="<?php echo e(cleanLang(__('lang.download'))); ?>" title="<?php echo e(cleanLang(__('lang.download'))); ?>"
                class="data-toggle-tooltip data-toggle-tooltip hidden btn btn-outline-warning btn-circle btn-sm"
                href="<?php echo e(url('/invoices/'.$invoice->invoice_id.'/pdf')); ?>" download>
                <i class="ti-import"></i></a>
            <?php endif; ?>
            <!--delete-->
            <?php if(config('visibility.action_buttons_delete')): ?>
            <button type="button" title="<?php echo e(cleanLang(__('lang.delete'))); ?>"
                class="data-toggle-action-tooltip hidden btn btn-outline-danger btn-circle btn-sm confirm-action-danger"
                data-confirm-title="<?php echo e(cleanLang(__('lang.delete_invoice'))); ?>"
                data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>" data-ajax-type="DELETE"
                data-url="<?php echo e(url('/')); ?>/invoices/<?php echo e($invoice->invoice_id); ?>/delete">
                <i class="sl-icon-trash"></i>
            </button>
            <?php endif; ?>
            <!--edit-->
            <?php if(config('visibility.action_buttons_edit')): ?>
            <!-- <a href="<?php echo e(url('/invoices/'. $invoice->invoice_id.'/edit-invoice')); ?>" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-info btn-circle btn-sm">
                <i class="sl-icon-note"></i>
            </a> -->
            <button type="button" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                class="data-toggle-action-tooltip hidden btn btn-outline-success btn-circle btn-sm edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                data-toggle="modal" data-target="#commonModal"
                data-url="<?php echo e(urlResource('/invoices/'.$invoice->invoice_id.'/edit')); ?>"
                data-loading-target="commonModalBody" data-modal-title="<?php echo e(cleanLang(__('lang.edit_invoice'))); ?>"
                data-action-url="<?php echo e(urlResource('/invoices/'.$invoice->invoice_id.'?ref=list')); ?>"
                data-action-method="PUT" data-action-ajax-class=""
                data-action-ajax-loading-target="commonModalBody">
                <i class="sl-icon-note"></i>
            </button>
            <?php endif; ?>
            <!-- <a href="<?php echo e(url('/invoices/'. $invoice->invoice_id)); ?>" title="<?php echo e(cleanLang(__('lang.view'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-info btn-circle btn-sm">
...
<!--each row-->
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/invoices/components/table/ajax.blade.php ENDPATH**/ ?>