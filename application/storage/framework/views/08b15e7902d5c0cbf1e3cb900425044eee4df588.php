    ...
    <div id="list-page-actions">
        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                <!--stop all timers-->
                <a href="javascript:void(0)" class="dropdown-item confirm-action-danger" data-confirm-title="<?php echo e(cleanLang(__('lang.stop_all_timers'))); ?>"
...
<!-- action buttons -->
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/project/components/misc/actions.blade.php ENDPATH**/ ?>