...
<div class="row">
    <div class="col-lg-12">
        <input type="hidden" id="prj_id" name="prj_id" value="">
        <script>
            $(document).ready(function() {

                // console.log($('#tabs-menu-overview').attr('href'));
                let url = $('#tabs-menu-overview').attr('href');
                let lastSegment = url.split('/').pop();
                console.log(lastSegment); // Output: "1"
                $('#prj_id').val(lastSegment);
...
<script>
    $(document).ready(function() {
        ...
        $('#inventoryModalForm').on('submit', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('projectinventory.inventory-submit')); ?>",
                data: $(this).serialize(),
                headers: {
...
<?php /**PATH C:\xampp\htdocs\orion\application\resources\views/pages/projectinventory/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>