<!-- right-sidebar -->
<div class="right-sidebar" id="sidepanel-filter-addressb">
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                ...
                <span>
                    <i class="ti-close js-toggle-side-panel" data-target="sidepanel-filter-addressb"></i>
                </span>
            </div>
            <!--title-->
            <!--body-->
            <div class="r-panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select name="filter_name" id="filter_name"
                                    class="form-control form-control-sm js-select2-basic-search select2-multiple select2-hidden-accessible"
                                    multiple="multiple" tabindex="-1" aria-hidden="true"
                                    data-ajax--url="<?php echo e(url('/')); ?>/feed/address?type=client"></select>
                                <!--select2 basic search-->
                            </div>
                        </div>
                    </div>
                ...
                <div class="buttons-block">
                    ...
                    <button type="button" class="btn btn-rounded-x btn-danger js-ajax-ux-request apply-filter-button"
                        data-url="<?php echo e(urlResource('/addressb/search')); ?>" data-type="form" data-ajax-type="GET"><?php echo e(cleanLang(__('lang.apply_filter'))); ?></button>
                </div>
...
<!--sidebar-->
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/addressb/components/misc/filter-contacts.blade.php ENDPATH**/ ?>