...
<tr id="ticket_<?php echo e($ticket->ticket_id); ?>">
    ...
    <td class="tickets_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <?php endif; ?>
            <a href="<?php echo e(url('/tickets/')); ?>/<?php echo e($ticket->ticket_id); ?>" title="<?php echo e(cleanLang(__('lang.view'))); ?>"
...
<!--each row--><?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/tickets/components/table/ajax.blade.php ENDPATH**/ ?>