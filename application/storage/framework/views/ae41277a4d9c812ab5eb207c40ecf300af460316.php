<head>
    ...
    <script src="/orion-ci-laravel/public/vendor/js/vendor.header.js?v=<?php echo e(config('system.versioning')); ?>"></script>

    <!--BOOTSTRAP-->
    <link href="/orion-ci-laravel/public/vendor/css/bootstrap/bootstrap.min.css" rel="stylesheet">
    ...
    <!--VENDORS CSS-->
    <link rel="stylesheet" href="/orion-ci-laravel/public/vendor/css/vendor.css?v=<?php echo e(config('system.versioning')); ?>">

    <!--THEME STYLE-->
    <link href="/orion-ci-laravel/<?php echo e(config('theme.selected_theme_css')); ?> " rel="stylesheet">

    <!-- Font Awesome -->
    <link rel="stylesheet"
        href="/orion-ci-laravel/hrms/skin/hrsale_assets/theme_assets/bower_components/font-awesome/css/font-awesome.min.css">

    <!--USERS CUSTON CSS FILE-->
    <link href="/orion-ci-laravel/public/css/custom.css?v=<?php echo e(config('system.versioning')); ?>" rel="stylesheet">

    <!-- Favicon icon -->
    <link rel="apple-touch-icon" sizes="57x57" href="/orion-ci-laravel/public/images/favicon/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="/orion-ci-laravel/public/images/favicon/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="/orion-ci-laravel/public/images/favicon/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="/orion-ci-laravel/public/images/favicon/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="/orion-ci-laravel/public/images/favicon/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="/orion-ci-laravel/public/images/favicon/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="/orion-ci-laravel/public/images/favicon/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="/orion-ci-laravel/public/images/favicon/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="/orion-ci-laravel/public/images/favicon/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192" href="/orion-ci-laravel/public/images/favicon/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/orion-ci-laravel/public/images/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="/orion-ci-laravel/public/images/favicon/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/orion-ci-laravel/public/images/favicon/favicon-16x16.png">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="/orion-ci-laravel/public/images/favicon/ms-icon-144x144.png">
    ...
    <script type="text/javascript">
        ...
        NXGMAP = (typeof NXGMAP == 'undefined') ? {} : NXGMAP;
    ...
    <!--boot js-->
    <script src="/orion-ci-laravel/public/js/core/head.js?v=<?php echo e(config('system.versioning')); ?>"></script>

    <!--[note: no sanitizing required] for this trusted content, which is added by the admin-->
    <?php echo config('system.settings_theme_head'); ?>

</head>
<?php /**PATH C:\xampp\htdocs\orion-ci-laravel\application\resources\views/layout/header.blade.php ENDPATH**/ ?>