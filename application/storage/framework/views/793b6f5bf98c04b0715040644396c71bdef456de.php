<div class="card count-<?php echo e(@count($grn_data)); ?>" id="notes-table-wrapper">
    <div class="card-body">
            ...
            <table id="note-foo-addrow" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
                <thead>
                    <tr>
                        ...
                        <th class="notes_col_date">Statu</th>
                ...
                <tbody id="notes-td-container">
                    <!--ajax content here-->
                    <?php echo $__env->make('pages.prq.components.table.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!--ajax content here-->
                </tbody>
                <tfoot>
                    <tr>
...
<?php /**PATH /www/wwwroot/orion.braincave.work/application/resources/views/pages/prq/components/table/table.blade.php ENDPATH**/ ?>